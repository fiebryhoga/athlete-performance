  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex flex-row items-center md:items-stretch w-full mx-auto h-[300px] sm:h-[360px] md:h-[400px] gap-2 sm:gap-4 md:gap-0 flex-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "relative w-[100px] sm:w-[140px] md:w-[180px] h-full shrink-0 group", children: [
            /* @__PURE__ */ jsx(
              "img",
              {
                src: imgUrl,
          ...
          /* @__PURE__ */ jsx("div", { className: "hidden md:block flex-1 relative min-w-[30px] lg:min-w-[50px] mx-1 shrink-0 pointer-events-none h-full", children: /* @__PURE__ */ jsx(
            "svg",
            {
              viewBox: "0 0 100 100",
          ...
          /* @__PURE__ */ jsx("div", { className: "flex-1 md:w-[280px] flex flex-col justify-between h-full shrink-0 relative z-10 space-y-2 py-0.5", children: sections.map((sec) => /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex-1 flex flex-col sm:flex-row sm:justify-between sm:items-center min-w-0", children: [
                  /* @__PURE__ */ jsx("span", { className: "font-bold text-slate-800 text-[11px] sm:text-xs truncate", children: sec.label }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-0.5 mt-0.5 sm:mt-0", children: [
