...
function ShowSession({
  ...
  route("admin.group-trainings.show", training.training_group_id);
  if (fromPage === "athlete" && athleteIdParam) {
    route("admin.individual-trainings.show", athleteIdParam);
  } else if (isAthlete) {
    route("admin.individual-trainings.show", auth.user.id);
  }
  ...
  const completeTraining = () => {
    const hasPhoto = data.proof_photo || currentPivot?.proof_photo && !data.remove_proof_photo;
...
${formattedMissing}`
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: `Detail Sesi - ${training.name || "Latihan"}`, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "pb-12 mx-auto space-y-8 relative", children: [
      /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-6", children: /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-indigo-900 via-indigo-800 to-violet-900 p-6 md:p-10 rounded-3xl border border-indigo-700/50 shadow-2xl relative overflow-hidden flex flex-col md:flex-row md:items-start justify-between gap-6 text-white", children: [
        /* @__PURE__ */ jsx("div", { className: "absolute top-0 right-0 w-96 h-96 bg-white/10 rounded-full blur-3xl -mr-20 -mt-20 pointer-events-none" }),
        /* @__PURE__ */ jsx("div", { className: "absolute bottom-0 left-0 w-64 h-64 bg-violet-500/20 rounded-full blur-3xl -ml-20 -mb-20 pointer-events-none" }),
        /* @__PURE__ */ jsxs("div", { className: "relative z-10 space-y-5 flex-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-3", children: [
            /* @__PURE__ */ jsxs("button", { type: "button", onClick: () => window.history.back(), className: "flex items-center gap-1.5 text-indigo-100 hover:text-white transition-colors text-sm font-semibold mr-2 bg-white/10 hover:bg-white/20 px-3 py-1.5 rounded-full backdrop-blur-md", children: [
              /* @__PURE__ */ jsx(ArrowLeft, { size: 16 }),
              " Kembali"
            ] }),
            /* @__PURE__ */ jsxs("span", { className: "text-xs font-bold text-white bg-indigo-500/50 px-3 py-1.5 rounded-full backdrop-blur-md border border-indigo-400/30 shadow-inner tracking-wide", children: [
              "Sesi ",
              training.session_number
            ] }),
            /* @__PURE__ */ jsx("span", { className: `text-xs font-bold px-3 py-1.5 rounded-full backdrop-blur-md border shadow-inner tracking-wide ${training.status === "completed" || training.is_completed ? "bg-emerald-500/30 text-emerald-50 border-emerald-400/30" : "bg-white/10 text-indigo-50 border-white/20"}`, children: training.status === "completed" || training.is_completed ? "Selesai" : "Terjadwal" })
          ] }),
          /* @__PURE__ */ jsx("h1", { className: "text-3xl md:text-4xl font-extrabold text-white tracking-tight drop-shadow-md", children: training.name || "Program Latihan Grup" }),
          /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-4 text-sm text-indigo-100", children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 bg-black/20 px-3 py-1.5 rounded-lg backdrop-blur-sm", children: [
              /* @__PURE__ */ jsx(Calendar, { size: 16, className: "text-indigo-300" }),
              /* @__PURE__ */ jsx("span", { className: "font-medium", children: training.date })
            ] }),
            training.training_type && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 bg-black/20 px-3 py-1.5 rounded-lg backdrop-blur-sm", children: [
              /* @__PURE__ */ jsx(Target, { size: 16, className: "text-indigo-300" }),
              /* @__PURE__ */ jsx("span", { className: "font-medium", children: training.training_type })
            ] }),
            training.location && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 bg-black/20 px-3 py-1.5 rounded-lg backdrop-blur-sm", children: [
              /* @__PURE__ */ jsx(MapPin, { size: 16, className: "text-indigo-300" }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "pt-3 flex flex-wrap items-center gap-3", children: [
            /* @__PURE__ */ jsx("span", { className: "text-xs font-bold text-indigo-200 uppercase tracking-wider", children: "Coach:" }),
            coaches && coaches.length > 0 ? /* @__PURE__ */ jsx("div", { className: "flex flex-wrap gap-2", children: coaches.map((c) => /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/10 rounded-full py-1 pr-4 pl-1 shadow-sm", children: [
              /* @__PURE__ */ jsx("div", { className: "w-7 h-7 rounded-full bg-gradient-to-tr from-indigo-400 to-violet-400 text-white flex items-center justify-center shadow-inner", children: /* @__PURE__ */ jsx(User, { size: 14 }) }),
              ...
              /* @__PURE__ */ jsx("div", { className: "w-7 h-7 rounded-full bg-white/20 text-indigo-100 flex items-center justify-center shadow-inner", children: /* @__PURE__ */ jsx(User, { size: 14 }) }),
      ...
      (!isCoachOrAdmin || mainTab === "detail") && /* @__PURE__ */ jsxs(Fragment, { children: [
        ...
        isAdmin && (() => {
          ...
          if (isCompleted) {
            return /* @__PURE__ */ jsxs("div", { className: "mt-4 p-3 rounded-lg border border-emerald-200 bg-emerald-50 flex items-center gap-2 text-sm text-emerald-800", children: [
              ...
              currentPivot?.completed_at && /* @__PURE__ */ jsxs("span", { className: "opacity-75", children: [
                "pada",
                " ",
                new Date(
        ...
        !isAthlete && /* @__PURE__ */ jsxs("div", { className: "mt-8 mb-6 bg-slate-50/80 p-3 rounded-2xl border border-slate-200 shadow-inner", children: [
          /* @__PURE__ */ jsx("h2", { className: "text-xs font-bold text-slate-400 uppercase tracking-wider mb-3 px-2", children: "Pilih Atlet (View By Athlete)" }),
          /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2 overflow-x-auto custom-scrollbar pb-2 px-2", children: sortedMembers.map((member) => {
            ...
            return /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                children: [
                  member.name,
                  member.isGuest && /* @__PURE__ */ jsx("span", { className: `text-[9px] px-1.5 py-0.5 rounded font-extrabold ml-1 ${isSelected ? "bg-white/20 text-white" : "bg-orange-100 text-orange-600"}`, children: "GUEST" }),
                  isDone && /* @__PURE__ */ jsx(CheckCircle2, { size: 16, className: isSelected ? "text-indigo-200" : "text-emerald-500" })
                ]
              },
              member.id
            );
        ...
        /* @__PURE__ */ jsxs(
          "form",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("div", { className: "flex flex-col gap-5 bg-transparent", children: training.blocks.filter((block) => {
                if (block.athlete_ids && Array.isArray(block.athlete_ids) && block.athlete_ids.length > 0) {
                  if (!block.athlete_ids.includes(selectedAthleteId)) return false;
                }
                  ...
                  "div",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-r from-slate-50 to-white border-b border-slate-100 px-6 py-5 flex flex-col gap-3 relative", children: [
                        /* @__PURE__ */ jsx("div", { className: "absolute left-0 top-0 bottom-0 w-1.5 bg-indigo-500 rounded-l-3xl" }),
                        /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between", children: /* @__PURE__ */ jsxs("h3", { className: "font-extrabold text-slate-800 text-lg flex items-center gap-3", children: [
                          /* @__PURE__ */ jsx("div", { className: "bg-indigo-100 p-1.5 rounded-lg text-indigo-600", children: /* @__PURE__ */ jsx(Target, { size: 18, strokeWidth: 2.5 }) }),
                          phaseLabel
                        ] }) }),
              ...
              isAthlete && /* @__PURE__ */ jsxs("div", { className: "p-4 sm:p-6 bg-white border-t border-zinc-200 flex flex-col gap-4", children: [
                ...
                /* @__PURE__ */ jsxs("div", { children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
                    ...
                    ] }) : currentPivot?.proof_photo && !data.remove_proof_photo ? /* @__PURE__ */ jsxs("div", { className: "relative group shrink-0", children: [
                      /* @__PURE__ */ jsx(
                        "img",
                        {
                          ...
                          className: "h-16 w-16 sm:h-20 sm:w-20 object-cover rounded-lg border border-zinc-200 shadow-sm cursor-pointer",
                          onClick: () => openModal(
                            "/storage/" + currentPivot.proof_photo,
                            "image"
                          )
                        }
                      ),
                    ...
                    /* @__PURE__ */ jsxs(
                      "label",
                      {
                        ...
                        children: [
                          ...
                          " ",
                          data.proof_photo || currentPivot?.proof_photo && !data.remove_proof_photo ? "Change Photo" : "Upload Proof Photo"
                        ]
                      }
                    )
                  ] })
              ...
              isCoachOrAdmin && (currentPivot?.athlete_note || currentPivot?.proof_photo) && /* @__PURE__ */ jsxs("div", { className: "p-4 sm:p-6 bg-zinc-50 border-t border-zinc-200 flex flex-col gap-4", children: [
                ...
                currentPivot?.athlete_note && /* @__PURE__ */ jsx("div", { className: "bg-white border border-zinc-200 p-4 rounded-xl shadow-sm", children: /* @__PURE__ */ jsxs("p", { className: "text-sm text-zinc-700 italic", children: [
                  '"',
                  currentPivot.athlete_note,
                  '"'
                ] }) }),
                currentPivot?.proof_photo && /* @__PURE__ */ jsxs(
                  "button",
                  {
                    type: "button",
                    onClick: () => openModal(
    ...
    confirmComplete && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/80 backdrop-blur-sm transition-opacity", children: /* @__PURE__ */ jsxs("div", { className: "bg-white border border-slate-200 rounded-2xl shadow-2xl w-full max-w-md overflow-hidden flex flex-col p-6 animate-in fade-in zoom-in-95 duration-200", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "mb-5 bg-slate-50 p-4 rounded-xl border border-slate-200", children: /* @__PURE__ */ jsxs("p", { className: "text-sm text-slate-700", children: [
        "Menyelesaikan latihan untuk: ",
        /* @__PURE__ */ jsx("strong", { children: sortedMembers.find((m) => m.id === selectedAthleteId)?.name })
      ] }) }),
      /* @__PURE__ */ jsxs("p", { className: "text-slate-600 mb-6 text-xs leading-relaxed", children: [
        "Apakah Anda yakin ingin menyelesaikan dan menyerahkan program latihan untuk atlet ini? Setelah diserahkan, data aktual sudah",
        " ",
