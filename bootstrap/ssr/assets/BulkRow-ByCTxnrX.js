...
const COLUMNS = [
  ...
  { id: "bmi", width: "w-20", step: "0.1", readOnly: true },
...
function BulkRow({ player, visibleIdx, actions }) {
  return /* @__PURE__ */ jsxs(
    "tr",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("td", { className: "sticky left-0 z-10 bg-white  group-hover:bg-zinc-50  border-r border-zinc-200  px-3 py-2 transition-colors", children: /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          /* @__PURE__ */ jsx(
            "div",
            {
              draggable: true,
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col", children: [
            /* @__PURE__ */ jsx("span", { className: "font-bold text-zinc-900  text-xs line-clamp-1", children: player.name }),
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 mt-0.5", children: [
              /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold text-zinc-500 bg-zinc-100  px-1 rounded", children: player.position }),
        ...
        COLUMNS.map((col) => /* @__PURE__ */ jsx(
          "td",
          {
            className: "px-2 py-2 text-center bg-white  group-hover:bg-zinc-50  transition-colors relative",
        ...
        /* @__PURE__ */ jsx("td", { className: "sticky right-0 z-10 bg-white  group-hover:bg-zinc-50  border-l border-zinc-200  px-2 py-2 text-center transition-colors", children: /* @__PURE__ */ jsx(
          "button",
          {
