...
function ClientIndex({ auth, athletes }) {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: "Data Klien Wellness", children: [
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "p-3.5 space-y-3 flex-1 flex flex-col justify-between", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2.5", children: [
                  /* @__PURE__ */ jsx("div", { className: "w-10 h-10 sm:w-11 sm:h-11 rounded-md border-2 border-white shadow-2xs bg-gradient-to-br from-orange-50 to-orange-100/70 text-orange-600 font-black text-base flex items-center justify-center shrink-0 overflow-hidden", children: photo ? /* @__PURE__ */ jsx("img", { src: photo, alt: athlete.name, className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsx("span", { className: "leading-none select-none", children: getInitials(athlete.name) }) }),
                  /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1 space-y-0.5", children: [
                    ...
                    /* @__PURE__ */ jsx("p", { className: "text-[11px] text-slate-500 font-medium truncate", children: athlete.sport?.name || "Athlete" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-1.5 pt-0.5 border-t border-slate-100/90", children: [
                  /* @__PURE__ */ jsxs("div", { className: "p-1.5 bg-white/90 rounded-md border border-slate-200/70 shadow-2xs", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[8px] font-bold text-slate-400 uppercase tracking-wider block", children: "Update" }),
                    /* @__PURE__ */ jsx("div", { className: "mt-0.5", children: /* @__PURE__ */ jsx("span", { className: "text-[9.5px] font-bold text-slate-700 leading-tight block truncate", children: athlete.latest_wellness ? new Date(athlete.latest_wellness.record_date).toLocaleDateString("id-ID", { day: "numeric", month: "short" }) : "-" }) })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "p-1.5 bg-white/90 rounded-md border border-slate-200/70 shadow-2xs", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[8px] font-bold text-slate-400 uppercase tracking-wider block", children: "Score" }),
                    /* @__PURE__ */ jsx("div", { className: "flex items-baseline gap-0.5 mt-0.5", children: /* @__PURE__ */ jsx("span", { className: "text-[11.5px] font-black text-orange-600 leading-tight", children: athlete.latest_wellness?.daily_wellness_score || "-" }) })
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "px-3.5 py-2 bg-gradient-to-r from-slate-50/90 via-white to-orange-50/30 border-t border-slate-100 flex items-center justify-between text-xs", children: [
                /* @__PURE__ */ jsx("span", { className: "text-[9.5px] font-bold text-slate-500", children: athlete.sport?.name || "Athlete" }),
