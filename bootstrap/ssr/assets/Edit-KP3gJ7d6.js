...
import { ArrowLeft, Video, Trash2, Plus, CheckCircle, Save, Image, PlayCircle, ExternalLink } from "lucide-react";
import "axios";
function Edit({ exercise, categories = [] }) {
  const {
    data,
    setData,
    post,
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: "Edit Latihan", children: [
    /* @__PURE__ */ jsx(Head, { title: `Edit Latihan - ${exercise.name}` }),
    /* @__PURE__ */ jsxs("div", { className: "pb-12 space-y-8", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-8", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "lg:col-span-2 space-y-6", children: [
          /* @__PURE__ */ jsxs("div", { className: "bg-white border border-slate-200 rounded-xl p-6 shadow-sm", children: [
            ...
            data.images.length > 0 && /* @__PURE__ */ jsxs("div", { className: "mb-8 p-5 border border-slate-200 bg-slate-50/50 rounded-xl", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center mb-4", children: [
                /* @__PURE__ */ jsxs("h4", { className: "text-xs font-bold text-slate-900 flex items-center gap-2", children: [
                  /* @__PURE__ */ jsx(Image, { size: 14 }),
                  " Pratinjau Gambar Baru"
                ] }),
                /* @__PURE__ */ jsx("span", { className: "text-[10px] text-slate-600 font-semibold bg-slate-200 px-2 py-1 rounded", children: 'Tekan "Simpan Perubahan" untuk mengunggah.' })
              ] }),
            ...
            /* @__PURE__ */ jsx("h4", { className: "text-[10px] font-bold text-slate-400 mb-4 border-b border-slate-100 pb-2", children: "Gambar Tersimpan di Server" }),
            data.existing_images?.length > 0 ? /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4", children: data.existing_images.map((path, idx) => /* @__PURE__ */ jsxs("div", { className: "relative aspect-square rounded-lg overflow-hidden border border-slate-200 group shadow-sm", children: [
              /* @__PURE__ */ jsx("img", { src: path, className: "w-full h-full object-cover" }),
              /* @__PURE__ */ jsx(
                "button",
                {
            ...
            ] }, `saved-${idx}`)) }) : /* @__PURE__ */ jsx("div", { className: "py-12 text-center border border-dashed border-slate-200 rounded-xl text-slate-400 text-sm bg-slate-50/50", children: "Belum ada gambar yang tersimpan." })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "bg-white border border-slate-200 rounded-xl p-6 shadow-sm", children: [
            /* @__PURE__ */ jsxs("h3", { className: "font-bold flex items-center gap-2 mb-6", children: [
              /* @__PURE__ */ jsx(PlayCircle, { size: 18 }),
              " Video Tersimpan"
            ] }),
            /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: data.videos?.filter((v) => v.trim() !== "").length > 0 ? data.videos.filter((v) => v.trim() !== "").map((url, i) => /* @__PURE__ */ jsxs(
              "a",
              {
                href: url,
                target: "_blank",
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
                    /* @__PURE__ */ jsx("div", { className: "p-2 bg-white rounded-md shadow-sm border border-slate-200", children: /* @__PURE__ */ jsx(Video, { size: 14, className: "text-slate-500" }) }),
                    /* @__PURE__ */ jsxs("span", { className: "text-xs font-bold truncate max-w-[150px] text-slate-700", children: [
                      "Tautan Video ",
                      i + 1
                    ] })
                  ] }),
                  /* @__PURE__ */ jsx(ExternalLink, { size: 14, className: "text-slate-400 group-hover:text-slate-900" })
                ]
              },
              i
            )) : /* @__PURE__ */ jsx("div", { className: "col-span-full text-xs text-slate-400 text-center py-4", children: "Belum ada tautan video yang disimpan." }) })
          ] })
        ] })
      ] })
    ] })
