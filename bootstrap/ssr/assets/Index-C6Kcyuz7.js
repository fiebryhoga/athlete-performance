...
import { Calendar, Search, User, Users, ChevronRight, Dumbbell } from "lucide-react";
...
function Index({ athletes, groups }) {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: "Recovery Strategi", children: [
    /* @__PURE__ */ jsx(Head, { title: "Recovery Strategi" }),
    /* @__PURE__ */ jsx(
      PageHeader,
      {
        title: "Recovery Strategi",
        subtitle: "Pilih athlete atau grup untuk menjadwalkan strategi pemulihan (recovery) mereka.",
        badge: "Recovery",
        icon: Calendar,
    ...
    /* @__PURE__ */ jsxs("div", { className: "pb-12 space-y-6", children: [
      ...
      activeTab === "individual" ? /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5", children: filteredAthletes.map((athlete) => /* @__PURE__ */ jsx(Link, { href: route("admin.recovery-strategies.show", athlete.id), className: "block group", children: /* @__PURE__ */ jsxs("div", { className: "bg-white border border-slate-200 hover:border-slate-900 hover:shadow-md rounded-xl p-5 transition-all shadow-sm flex flex-col h-full relative overflow-hidden group-hover:-translate-y-1", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-auto pt-4 border-t border-slate-100 flex items-center justify-between relative z-10", children: [
            ...
            athlete.sport && /* @__PURE__ */ jsxs("div", { className: "text-right", children: [
              /* @__PURE__ */ jsx("p", { className: "text-[10px] font-bold text-slate-400", children: "Olahraga" }),
              /* @__PURE__ */ jsx("p", { className: "text-sm font-semibold text-slate-900 mt-1", children: athlete.sport.name })
            ] })
          ] })
        ] }) }, athlete.id)) }),
        ...
        /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5", children: filteredGroups.map((group) => /* @__PURE__ */ jsx(Link, { href: route("admin.recovery-strategies.group.show", group.id), className: "block group", children: /* @__PURE__ */ jsxs("div", { className: "bg-white border border-slate-200 hover:border-slate-900 hover:shadow-md rounded-xl p-5 transition-all shadow-sm flex flex-col h-full relative overflow-hidden group-hover:-translate-y-1", children: [
          /* @__PURE__ */ jsx("div", { className: "absolute -right-4 -top-4 w-24 h-24 bg-slate-50 rounded-full opacity-50 group-hover:scale-150 transition-transform duration-500 pointer-events-none" }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-start mb-4 relative z-10", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "mt-auto pt-4 border-t border-slate-100 relative z-10", children: [
            ...
            group.members?.length > 0 && /* @__PURE__ */ jsx("div", { className: "pt-3 border-t border-slate-50 flex flex-wrap gap-1", children: group.members.map((member) => /* @__PURE__ */ jsx("span", { className: "inline-flex items-center px-1.5 py-0.5 rounded text-[9px] font-medium bg-slate-50 border border-slate-200 text-slate-600", children: member.name }, member.id)) })
          ] })
        ] }) }, group.id)) }),
