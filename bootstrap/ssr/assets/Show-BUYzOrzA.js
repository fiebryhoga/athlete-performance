...
const INDONESIAN_FOODS = {
    carbs: [
        ...
        {
            name: "Mashed Potato (Kentang Tumbuk)",
            portion: "150g",
            protein: 3,
            carbs: 20,
            fats: 4,
        ...
        {
            name: "Roti Tawar Gandum Panggang",
            portion: "60g",
            protein: 7,
            carbs: 26,
            fats: 2,
    ...
    proteins: [
        ...
        {
            name: "Dada Ayam Filet Tepung (Katsu)",
            portion: "100g",
            protein: 20,
            carbs: 15,
            fats: 12,
        ...
        {
            name: "Sate Ayam (Tanpa Bumbu Kacang)",
        ...
        {
            name: "Susu Sapi Cair Full Cream",
            portion: "200ml",
            protein: 6,
            carbs: 10,
            fats: 7,
    ...
    vegetables: [
        ...
        {
            name: "Terong Balado (sedikit minyak)",
            portion: "100g",
            protein: 1,
            carbs: 6,
            fats: 3,
        ...
        {
            name: "Sayur Sop (Wortel, Buncis, Kol)",
            portion: "150g",
            protein: 2,
            carbs: 9,
            fats: 1,
    ...
    fruits_snacks: [
        ...
        {
            name: "Pisang Sunpride / Cavendish",
            portion: "1 buah (120g)",
            protein: 1.3,
            carbs: 27,
            fats: 0.4,
...
function fp(food, scale) {
    ...
    const eu = food.portion.match(
        /^([\d.]+)\s*(buah|lembar|butir|tusuk|scoop|ekor|tongkol|sdm|bungkus|cup|keping|gelas)/i,
    );
...
function fc(count, unit, grams) {
    const isDiscrete =
        /buah|butir|ekor|lembar|tongkol|tusuk|scoop|sdm|bungkus|cup|keping|gelas/i.test(
            unit,
        );
    let step = 0.25;
    if (isDiscrete) {
    ...
    if (finalCals > 0) {
        ...
        if (Math.abs(ratioCal - 1) > 0.02) {
            items = items.map((item) => {
                ...
                return food
                    ? mi(food, cl(item.scale * ratioCal, 0.25, 3.5))
                    : item;
            });
        }
    }
...
const LUNCH = {
    ...
    defaultSides: [
        ...
        "Tumis Pakcoy Bawang Putih",
        "Tauge Rebus",
        "Kubis / Kol Rebus",
        "Labu Siam Kukus",
        "Terong Balado (sedikit minyak)",
        "Sayur Sop (Wortel, Buncis, Kol)",
        "Sayur Asem",
        "Sayur Lodeh",
        "Capcay Kuah",
        "Tomat Segar",
...
const CC = {
    ...
    "Nasi Liwet": {
        ...
        sides: ["Timun Segar", "Tomat Segar", "Daun Singkong Rebus"],
    },
    "Mie Goreng": {
        proteins: [
            "Telur Ceplok (Mata Sapi)",
    ...
    "Bihun Goreng": {
        ...
        sides: ["Sawi Hijau", "Sawi Putih", "Wortel Rebus"],
    },
    "Kwetiau Goreng": {
        proteins: [
            "Telur Ceplok (Mata Sapi)",
        ...
        sides: ["Sawi Hijau", "Sawi Putih", "Tauge Rebus"],
    },
    "Soun Goreng": {
        proteins: [
            "Telur Ceplok (Mata Sapi)",
    ...
    "Nasi Uduk": {
        ...
        sides: ["Timun Segar", "Tomat Segar", "Acar Kuning"],
    },
    "Lontong / Ketupat": {
        proteins: [
            "Telur Ayam Rebus",
    ...
    "Makaroni Gandum": {
        ...
        sides: ["Brokoli Kukus", "Wortel Rebus"],
    },
    ...
    "Jagung Manis Rebus": {
        ...
        sides: ["Bayam Bening", "Bening Bayam Jagung"],
    },
    "Singkong Rebus": {
        proteins: [
            "Telur Ayam Rebus",
    ...
    "Kentang Rebus": {
        ...
        sides: ["Brokoli Kukus", "Wortel Rebus", "Buncis Rebus"],
    },
    "Mashed Potato (Kentang Tumbuk)": {
        proteins: [
            "Dada Ayam (Rebus/Panggang)",
...
const PC = {
    ...
    "Rawon Daging Sapi": {
        sides: ["Tauge Rebus", "Telur Asin", "Tempe Goreng"],
    },
    "Tongseng Kambing": {
        sides: ["Tomat Segar", "Kubis / Kol Rebus", "Timun Segar"],
    },
    "Gulai Kambing": {
        sides: ["Daun Singkong Rebus", "Tumis Daun Singkong", "Timun Segar"],
    },
    "Gulai Ayam": {
        sides: ["Daun Singkong Rebus", "Tumis Daun Singkong", "Timun Segar"],
    },
    "Sayur Nangka Muda (Gulai)": {
        sides: ["Daun Singkong Rebus", "Tumis Daun Singkong"],
    },
    "Ayam Bakar Taliwang": {
        sides: ["Plecing Kangkung", "Timun Segar", "Tomat Segar"],
    },
    "Ayam Betutu": {
        sides: ["Plecing Kangkung", "Urap Sayur", "Tumis Kacang Panjang"],
    },
    "Ikan Bandeng Bakar": {
        sides: [
            "Sayur Asem",
    ...
    "Ayam Goreng Paha": {
        sides: ["Sayur Asem", "Sayur Lodeh", "Tomat Segar", "Timun Segar"],
    },
    "Rendang Sapi": {
        sides: ["Daun Singkong Rebus", "Tumis Daun Singkong", "Timun Segar"],
    },
...
function getPool(carbName, pool, field) {
    ...
    return (
        pool["default" + field.charAt(0).toUpperCase() + field.slice(1)] || []
    );
}
function getValidSides(carbName, protName, pool, goal) {
    let sides = pool.defaultSides || [];
    let ccSides =
        CC[carbName] && CC[carbName].sides ? CC[carbName].sides : void 0;
    let pcSides =
        PC[protName] && PC[protName].sides ? PC[protName].sides : void 0;
    if (ccSides && pcSides) {
...
function generateWeeklyMealPlan(
    ...
    return dailySplits.map((split, dayIdx) => {
        ...
        const dayP = (targetCalories * r.p) / 4,
            dayC = (targetCalories * r.c) / 4,
            dayF = (targetCalories * r.f) / 9;
        const meals = MEAL_SLOTS.map((slot, mealIdx) => {
            ...
            return {
                ...
                items,
                menu: items
                    .map((i) => `${i.scaledPortion} ${i.displayName}`)
                    .join(" + "),
...
function rerollMeal(meal) {
    ...
    const items = buildMeal(
        ...
        meal._targets,
        ns,
        meal._goal || "maintenance",
        meal._splitType || "Moderate Carb",
    );
    const totals = si(items);
    return {
        ...meal,
...
function rerollMealItem(meal, itemIndex) {
    ...
    if (itemIndex === 0) {
        ...
        let availableNames = allCarbs.filter((cName) => {
            const c = CC[cName];
            if (!c) return true;
            if (currentProt && c.proteins && !c.proteins.includes(currentProt))
                return false;
            if (currentSide && c.sides && !c.sides.includes(currentSide))
                return false;
            return true;
        });
        ...
        const validProts = fg(
            getPool(newCarbBase.name, pool, "proteins"),
            goal,
        );
        ...
        const validSides = getValidSides(
            newCarbBase.name,
            finalProtName,
            pool,
            goal,
        ...
        const finalNames =
            filteredNames.length > 0 ? filteredNames : availableNames;
            ...
            children: [
                /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                        /* @__PURE__ */ jsxs("div", {
                            className:
                                "bg-white rounded-xl border border-zinc-200 p-4 shadow-sm hover:border-orange-300 hover:shadow-md transition-all group",
                            children: [
                                /* @__PURE__ */ jsxs("div", {
                                    className:
                                    ...
                                    children: [
                                        /* @__PURE__ */ jsx("h3", {
                                            className:
                                                "text-zinc-500 font-bold text-[10px] uppercase tracking-widest",
                                            children: "Target Kalori",
                                        }),
                                        /* @__PURE__ */ jsx(Flame, {
                                            size: 14,
                                            className:
                                ...
                                /* @__PURE__ */ jsxs("div", {
                                    ...
                                    children: [
                                        /* @__PURE__ */ jsx("p", {
                                            className:
                                                "text-xl font-black text-zinc-900 group-hover:text-orange-600 transition-colors",
                                            children:
                                        ...
                                        /* @__PURE__ */ jsx("p", {
                                            className:
                                                "text-zinc-400 font-medium text-[12px]",
                                            children: "kcal/hr",
                                        }),
                                    ],
                                }),
                        ...
                        /* @__PURE__ */ jsxs("div", {
                            className:
                                "bg-white rounded-xl border border-zinc-200 p-4 shadow-sm hover:border-rose-300 hover:shadow-md transition-all group",
                            children: [
                                /* @__PURE__ */ jsxs("div", {
                                    className:
                                        "flex items-center justify-between mb-2",
                                    children: [
                                        ...
                                        /* @__PURE__ */ jsx("div", {
                                            className:
                                                "w-2 h-2 rounded-full bg-rose-500 group-hover:scale-125 transition-transform",
                                        }),
                                    ],
                                }),
                                /* @__PURE__ */ jsxs("div", {
                                    ...
                                    children: [
                                        /* @__PURE__ */ jsx("p", {
                                            className:
                                                "text-xl font-black text-zinc-900 group-hover:text-rose-600 transition-colors",
                                            children:
                                                planToDisplay.protein_target ||
                                                planToDisplay.macro_plan
                                                    ?.protein?.grams ||
                                                "-",
                                        }),
                                        /* @__PURE__ */ jsx("p", {
                        ...
                        /* @__PURE__ */ jsxs("div", {
                            className:
                                "bg-white rounded-xl border border-zinc-200 p-4 shadow-sm hover:border-emerald-300 hover:shadow-md transition-all group",
                            children: [
                                /* @__PURE__ */ jsxs("div", {
                                    className:
                                        "flex items-center justify-between mb-2",
                                    children: [
                                        /* @__PURE__ */ jsx("h3", {
                                            className:
                                                "text-zinc-500 font-bold text-[10px] uppercase tracking-widest",
                                            children: "Karbohidrat",
                                        }),
                                        /* @__PURE__ */ jsx("div", {
                                            className:
                                                "w-2 h-2 rounded-full bg-emerald-500 group-hover:scale-125 transition-transform",
                                        }),
                                    ],
                                }),
                                /* @__PURE__ */ jsxs("div", {
                                    ...
                                    children: [
                                        /* @__PURE__ */ jsx("p", {
                                            className:
                                                "text-xl font-black text-zinc-900 group-hover:text-emerald-600 transition-colors",
                                            children:
                                                planToDisplay.carbs_target ||
                                                planToDisplay.macro_plan?.carbs
                                                    ?.grams ||
                                                "-",
                                        }),
                                        /* @__PURE__ */ jsx("p", {
                        ...
                        /* @__PURE__ */ jsxs("div", {
                            className:
                                "bg-white rounded-xl border border-zinc-200 p-4 shadow-sm hover:border-amber-300 hover:shadow-md transition-all group",
                            children: [
                                /* @__PURE__ */ jsxs("div", {
                                    className:
                                        "flex items-center justify-between mb-2",
                                    children: [
                                        ...
                                        /* @__PURE__ */ jsx("div", {
                                            className:
                                                "w-2 h-2 rounded-full bg-amber-500 group-hover:scale-125 transition-transform",
                                        }),
                                    ],
                                }),
                                /* @__PURE__ */ jsxs("div", {
                                    ...
                                    children: [
                                        /* @__PURE__ */ jsx("p", {
                                            className:
                                                "text-xl font-black text-zinc-900 group-hover:text-amber-600 transition-colors",
                                            children:
                                                planToDisplay.fats_target ||
                                                planToDisplay.macro_plan?.fats
                                                    ?.grams ||
                                                "-",
                                        }),
                                        /* @__PURE__ */ jsx("p", {
                ...
                /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                        /* @__PURE__ */ jsx("div", {
                            className:
                                "flex overflow-x-auto hide-scrollbar gap-3 pb-6 border-b border-zinc-100 px-1",
                            children: (
                                ...
                                return /* @__PURE__ */ jsxs(
                                    "button",
                                    {
                                        ...
                                        children: [
                                            /* @__PURE__ */ jsx("span", {
                                                className: `text-[10px] font-bold uppercase tracking-widest mb-1 ${activeTab === idx ? "text-orange-100" : "text-zinc-400"}`,
                                                children: dayName,
                                            }),
                                            /* @__PURE__ */ jsx("span", {
                                                className:
                                            ...
                                            /* @__PURE__ */ jsx("span", {
                                                className: `text-[10px] font-medium mt-1 ${activeTab === idx ? "text-orange-200" : "text-zinc-400"}`,
                                                children: monthName,
                                            }),
                                        ],
                                    },
                            ...
                            children: (() => {
                                ...
                                return /* @__PURE__ */ jsxs("div", {
                                    ...
                                    children: [
                                        /* @__PURE__ */ jsxs("div", {
                                            className:
                                                "bg-gradient-to-br from-orange-500 to-rose-500 rounded-xl p-5 md:p-2 text-white mb-6 shadow-lg shadow-orange-500/20 flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden",
                                            children: [
                                                /* @__PURE__ */ jsx("div", {
                                                    className:
                                                        "absolute top-0 right-0 -mt-8 -mr-8 w-64 h-64 bg-white opacity-5 rounded-full blur-3xl pointer-events-none",
                                                }),
                                                /* @__PURE__ */ jsx("div", {
                                                    className:
                                                        "absolute bottom-0 left-0 -mb-8 -ml-8 w-40 h-40 bg-white opacity-10 rounded-full blur-2xl pointer-events-none",
                                                }),
                                                /* @__PURE__ */ jsxs("div", {
                                                    className:
                                                        "flex flex-col md:flex-row items-center gap-6 text-center md:text-left relative z-10",
                                                    children: [
                                                        /* @__PURE__ */ jsxs(
                                                            "div",
                                                            {
                                                                className:
                                                                    "bg-white/20 backdrop-blur-md p-3 rounded-xl flex flex-col items-center justify-center shrink-0 border border-white/30 shadow-inner",
                                                                children: [
                                                                    /* @__PURE__ */ jsx(
                                                                        "span",
                                                                        {
                                                                            className:
                                                                                "text-xs font-bold text-orange-100",
                                                                            children:
                                                                                day.day.split(
                                                                                    ",",
                                                                                )[0],
                                                                    ...
                                                                    /* @__PURE__ */ jsx(
                                                                        ...
                                                                        {
                                                                            className:
                                                                                "text-xl font-bold text-white leading-none mt-1",
                                                                            children:
                                                                                new Date(
                                                                                    day.date,
                                                                                ).getDate(),
                                                            ...
                                                            "div",
                                                            {
                                                                children: [
                                                                    /* @__PURE__ */ jsx(
                                                                        ...
                                                                        {
                                                                            className:
                                                                                "text-xl md:text-xl font-black text-white",
                                                                            children:
                                                                                "Jadwal Makan Harian",
                                                                        },
                                                                    ),
                                                                        ...
                                                                        "div",
                                                                        {
                                                                            ...
                                                                            children:
                                                                                ...
                                                                                /* @__PURE__ */ jsx(
                                                                                    ...
                                                                                    {
                                                                                        className:
                                                                                            "inline-flex gap-1.5 text-xs font-bold text-white ",
                                                                                        children:
                                                                                            day.splitType,
                                                                                    },
                                                                                ),
                                                ...
                                                dayTotals &&
                                                    /* @__PURE__ */ jsxs(
                                                        ...
                                                        {
                                                            className:
                                                                "px-6 py-2 text-center min-w-[180px] relative z-10 shadow-inner",
                                                            children: [
                                                                /* @__PURE__ */ jsx(
                                                                    "p",
                                                                    {
                                                                        className:
                                                                            "text-[10px] font-bold text-orange-200",
                                                                        children:
                                                                            "Target Harian",
                                                                    },
                                                                ),
                                                                        ...
                                                                        children:
                                                                            [
                                                                                ...
                                                                                /* @__PURE__ */ jsx(
                                                                                    ...
                                                                                    {
                                                                                        className:
                                                                                            "text-orange-200 font-bold text-sm uppercase",
                                                                                        children:
                                                                                            "kcal",
                                                                                    },
                                                                                ),
                                        ...
                                        /* @__PURE__ */ jsxs("div", {
                                            ...
                                            children: [
                                                /* @__PURE__ */ jsx("div", {
                                                    className:
                                                        "absolute top-0 bottom-0 left-[19px] md:left-[27px] w-[3px] bg-gradient-to-b from-orange-200 via-orange-100 to-transparent rounded-full hidden sm:block",
                                                }),
                                                day.meals.map((meal, mealIdx) =>
                                                    /* @__PURE__ */ jsxs(
                                                        ...
                                                        {
                                                            className:
                                                                "relative mb-8 last:mb-0 group",
                                                            children: [
                                                                /* @__PURE__ */ jsx(
                                                                    "div",
                                                                    {
                                                                        className:
                                                                            "hidden sm:flex absolute top-7 left-0 md:left-3 w-8 h-8 rounded-full bg-white border-[3px] border-orange-500 items-center justify-center shadow-lg shadow-orange-500/30 z-10 transition-transform group-hover:scale-110",
                                                                        children:
                                                                            /* @__PURE__ */ jsx(
                                                                                "div",
                                                                                {
                                                                ...
                                                                /* @__PURE__ */ jsx(
                                                                    ...
                                                                    {
                                                                        className:
                                                                            "bg-white border border-zinc-100 rounded-xl p-5 md:p-6 hover:border-orange-300 hover:shadow-xl hover:shadow-orange-500/10 transition-all ml-0 sm:ml-16 md:ml-20 relative overflow-hidden",
                                                                        children:
                                                                            /* @__PURE__ */ jsxs(
                                                                                "div",
                                                                                {
                                                                                        ...
                                                                                        [
                                                                                                    ...
                                                                                                    children:
                                                                                                        [
                                                                                                                    ...
                                                                                                                    children:
                                                                                                                        [
                                                                                                                            /* @__PURE__ */ jsx(
                                                                                                                                ...
                                                                                                                                {
                                                                                                                                    className:
                                                                                                                                        "text-2xl md:text-xl font-bold text-zinc-900 tracking-tight",
                                                                                                                                    children:
                                                                                                                                        meal.time,
                                                                                                                                },
                                                                                                                            ),
                                                                                                                            /* @__PURE__ */ jsx(
                                                                                                                                ...
                                                                                                                                {
                                                                                                                                    className:
                                                                                                                                        "px-3 py-1.5  text-[10px] font-bold uppercase tracking-widest rounded-xl shadow-sm",
                                                                                                                                    children:
                                                                                                                                        meal.type,
                                                                                                                                },
                                                                                                                            ),
                                                                                                            ...
                                                                                                            /* @__PURE__ */ jsxs(
                                                                                                                ...
                                                                                                                {
                                                                                                                    className:
                                                                                                                        "text-zinc-500 font-medium text-xs flex items-center gap-1.5 mb-2",
                                                                                                                    children:
                                                                                                                        [
                                                                                                                            "Target kalori: ",
                                                                                                                            /* @__PURE__ */ jsxs(
                                                                                                                    ...
                                                                                                                    children:
                                                                                                                        ...
                                                                                                                        meal
                                                                                                                            ...
                                                                                                                            ? meal.items.map(
                                                                                                                                  (
                                                                                                                                      ...
                                                                                                                                      /* @__PURE__ */ jsxs(
                                                                                                                                          ...
                                                                                                                                          {
                                                                                                                                              className:
                                                                                                                                                  "flex items-start justify-between p-2.5 rounded-xl bg-zinc-50 hover:bg-orange-50/50 border border-transparent hover:border-orange-200 transition-colors group/item",
                                                                                                                                              children:
                                                                                                                                                  [
                                                                                                                                                      /* @__PURE__ */ jsxs(
                                                                                                                                                          "div",
                                                                                                                                                              ...
                                                                                                                                                              children:
                                                                                                                                                                  [
                                                                                                                                                                      /* @__PURE__ */ jsx(
                                                                                                                                                                          ...
                                                                                                                                                                          {
                                                                                                                                                                              className:
                                                                                                                                                                                  "w-4 h-4 rounded-full bg-white shadow-sm border border-zinc-100 flex items-center justify-center shrink-0 mt-0.5",
                                                                                                                                                                              children:
                                                                                                                                                                                  /* @__PURE__ */ jsx(
                                                                                                                                                                                      "div",
                                                                                                                                                                                      {
                                                                                                                                                                              ...
                                                                                                                                                                              children:
                                                                                                                                                                                  [
                                                                                                                                                                                      /* @__PURE__ */ jsx(
                                                                                                                                                                                          ...
                                                                                                                                                                                          {
                                                                                                                                                                                              className:
                                                                                                                                                                                                  "block text-[13px] text-zinc-800 font-bold",
                                                                                                                                                                                              children:
                                                                                                                                                                                                  item.displayName ||
                                                                                                                                                                                                  item.name,
                                                                                                                                                                                          },
                                                                                                                                                                                      ...
                                                                                                                                                                                      /* @__PURE__ */ jsxs(
                                                                                                                                                                                          ...
                                                                                                                                                                                          {
                                                                                                                                                                                              className:
                                                                                                                                                                                                  "flex flex-wrap items-center gap-x-2 gap-y-1 mt-1.5",
                                                                                                                                                                                              children:
                                                                                                                                                                                                  [
                                                                                                                                                                                                      /* @__PURE__ */ jsxs(
                                                                                                                                                                                                          "span",
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      /* @__PURE__ */ jsxs(
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          {
                                                                                                                                                                                                              className:
                                                                                                                                                                                                                  "text-[10px] font-medium text-rose-500 bg-rose-50 px-1.5 rounded",
                                                                                                                                                                                                              children:
                                                                                                                                                                                                                  [
                                                                                                                                                                                                                      "P: ",
                                                                                                                                                                                                                      item.protein,
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      /* @__PURE__ */ jsxs(
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          {
                                                                                                                                                                                                              className:
                                                                                                                                                                                                                  "text-[10px] font-medium text-emerald-500 bg-emerald-50 px-1.5 rounded",
                                                                                                                                                                                                              children:
                                                                                                                                                                                                                  [
                                                                                                                                                                                                                      "C: ",
                                                                                                                                                                                                                      item.carbs,
                                                                                                                                                                                                      ...
                                                                                                                                                                                                      /* @__PURE__ */ jsxs(
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          {
                                                                                                                                                                                                              className:
                                                                                                                                                                                                                  "text-[10px] font-medium text-amber-500 bg-amber-50 px-1.5 rounded",
                                                                                                                                                                                                              children:
                                                                                                                                                                                                                  [
                                                                                                                                                                                                                      "F: ",
                                                                                                                                                                                                                      item.fats,
                                                                                                                                                              ...
                                                                                                                                                              children:
                                                                                                                                                                  [
                                                                                                                                                                      /* @__PURE__ */ jsx(
                                                                                                                                                                          ...
                                                                                                                                                                          {
                                                                                                                                                                              className:
                                                                                                                                                                                  "text-[12px] text-zinc-600 font-bold mt-0.5",
                                                                                                                                                                              children:
                                                                                                                                                                                  item.scaledPortion,
                                                                                                                                                                          },
                                                                                                                                                                      ),
                                                                                                                                                                      isDraft &&
                                                                                                                                                                          /* @__PURE__ */ jsx(
                                                                                                                                                                              "button",
                                                                                                                                                                              {
                                                                                                                                                                                  ...
                                                                                                                                                                                  className:
                                                                                                                                                                                      "opacity-0 group-hover/item:opacity-100 hover:text-zinc-500 text-zinc-300 transition-all mt-0.5",
                                                                                                                                                                                  children:
                                                                                                                                                                                      /* @__PURE__ */ jsx(
                                                                                                                                                                                          RefreshCw,
                                                                                                                                                                                          {
                                                                                                                            ...
                                                                                                                            : /* @__PURE__ */ jsx(
                                                                                                                                  ...
                                                                                                                                  {
                                                                                                                                      className:
                                                                                                                                          "text-zinc-800 font-semibold px-2",
                                                                                                                                      children:
                                                                                                                                          meal.menu,
                                                                                                                                  },
                                                                                                                              ),
                                                                                                            ...
                                                                                                            /* @__PURE__ */ jsxs(
                                                                                                                ...
                                                                                                                {
                                                                                                                    className:
                                                                                                                        "mt-4 pt-2 border-t border-zinc-100 flex flex-wrap items-center gap-3",
                                                                                                                    children:
                                                                                                                        [
                                                                                                                            /* @__PURE__ */ jsxs(
                                                                                                                                "span",
                                                                                                                                {
                                                                                                                                    className:
                                                                                                                                        "flex items-center gap-2 px-4 py-2 bg-rose-50 text-rose-700 rounded-md text-xs font-bold border border-rose-100",
                                                                                                                                    children:
                                                                                                                                        [
                                                                                                                                            "Protein ",
                                                                                                                                            /* @__PURE__ */ jsxs(
                                                                                                                            ...
                                                                                                                            /* @__PURE__ */ jsxs(
                                                                                                                                ...
                                                                                                                                {
                                                                                                                                    className:
                                                                                                                                        "flex items-center gap-2 px-4 py-2 bg-emerald-50 text-emerald-700 rounded-md text-xs font-bold border border-emerald-100",
                                                                                                                                    children:
                                                                                                                                        [
                                                                                                                                            "Carbo ",
                                                                                                                                            /* @__PURE__ */ jsxs(
                                                                                                                            ...
                                                                                                                            /* @__PURE__ */ jsxs(
                                                                                                                                ...
                                                                                                                                {
                                                                                                                                    className:
                                                                                                                                        "flex items-center gap-2 px-4 py-2 bg-amber-50 text-amber-700 rounded-md text-xs font-bold border border-amber-100",
                                                                                                                                    children:
                                                                                                                                        [
                                                                                                                                            "Fat ",
                                                                                                                                            /* @__PURE__ */ jsxs(
                                                                                            ...
                                                                                            isDraft &&
                                                                                                /* @__PURE__ */ jsx(
                                                                                                    ...
                                                                                                    {
                                                                                                        className:
                                                                                                            "shrink-0 mt-4 md:mt-0 flex justify-end",
                                                                                                        children:
                                                                                                            /* @__PURE__ */ jsxs(
                                                                                                                "button",
                                                                                                                {
                                                                                                                    ...
                                                                                                                    className:
                                                                                                                        "flex items-center gap-2 px-3 py-2 bg-white hover:bg-orange-500 text-zinc-400 hover:text-white rounded-lg text-xs font-bold transition-all shadow-sm border border-zinc-200 hover:border-orange-500 group-hover:opacity-100 sm:opacity-0",
                                                                                                                    children:
                                                                                                                        [
                                                                                                                            /* @__PURE__ */ jsx(
                                                                                                                                RefreshCw,
                                                                                                                            ...
                                                                                                                            /* @__PURE__ */ jsx(
                                                                                                                                ...
                                                                                                                                {
                                                                                                                                    className:
                                                                                                                                        "sm:hidden group-hover:inline-block",
                                                                                                                                    children:
                                                                                                                                        "Reroll Sesi",
                                                                                                                                },
                                                                                                                            ),
                ...
                /* @__PURE__ */ jsxs("div", {
                    ...
                    children: [
                        /* @__PURE__ */ jsxs("div", {
                            className:
                                "bg-white border border-zinc-200 rounded-2xl p-6 shadow-sm relative overflow-hidden group hover:border-orange-300 transition-colors",
                            children: [
                                /* @__PURE__ */ jsx("div", {
                                    className:
                                        "absolute top-0 right-0 w-24 h-24 bg-orange-50 rounded-full -mr-12 -mt-12 group-hover:bg-orange-100 transition-colors",
                                }),
                                /* @__PURE__ */ jsxs("h4", {
                                    className:
                                        "text-[11px] font-black text-orange-500 uppercase tracking-widest mb-3 flex items-center gap-2 relative z-10",
                                    children: [
                                        /* @__PURE__ */ jsx(Target, {
                                            size: 16,
                                        }),
                                ...
                                /* @__PURE__ */ jsx("p", {
                                    className:
                                        "text-sm text-zinc-800 font-medium leading-relaxed relative z-10",
                                    children:
                                        planToDisplay.notes ||
                        ...
                        (planToDisplay.hydration_plan ||
                            ...
                            /* @__PURE__ */ jsxs("div", {
                                className:
                                    "bg-white border border-zinc-200 rounded-2xl p-6 shadow-sm relative overflow-hidden group hover:border-sky-300 transition-colors",
                                children: [
                                    /* @__PURE__ */ jsx("div", {
                                        className:
                                            "absolute top-0 right-0 w-24 h-24 bg-sky-50 rounded-full -mr-12 -mt-12 group-hover:bg-sky-100 transition-colors",
                                    }),
                                    /* @__PURE__ */ jsxs("h4", {
                                        className:
                                            "text-[11px] font-black text-sky-500 uppercase tracking-widest mb-4 flex items-center gap-2 relative z-10",
                                        children: [
                                            ...
                                            /* @__PURE__ */ jsxs("span", {
                                                className:
                                                    "text-zinc-700 bg-zinc-100 px-2 py-0.5 rounded ml-1",
                                                children: [
                                                    (
                                                        planToDisplay.hydration_plan ||
                                                        planToDisplay.hydration
                                        ...
                                        children: [
                                            ...
                                            .map((t, i) =>
                                                /* @__PURE__ */ jsxs(
                                                    ...
                                                    {
                                                        className:
                                                            "flex items-start gap-3 text-sm text-zinc-700 font-semibold bg-zinc-50 p-3 rounded-xl border border-zinc-100",
                                                        children: [
                                                            /* @__PURE__ */ jsx(
                                                                "div",
                                                                {
                                                                    className:
                                                                        "w-2 h-2 rounded-full bg-sky-400 mt-1.5 shrink-0",
                                                                },
                                                            ),
                                                            t,
                                                        ],
            ...
            /* @__PURE__ */ jsxs("div", {
                ...
                children: [
                    /* @__PURE__ */ jsx(PageHeader, {
                        title: `Rencana Makan ${player.name}`,
                        subtitle:
                            "Manajemen nutrisi dan jadwal diet khusus klien.",
                        badge: "Nutrisi & Diet",
                        icon: Flame,
                            ...
                            children:
                                ...
                                /* @__PURE__ */ jsxs(Fragment, {
                                    children: [
                                        /* @__PURE__ */ jsxs(Link, {
                                            href: route(
                                                "admin.meal-plans.index",
                                            ),
                                            className:
                                                "inline-flex flex-1 md:flex-none items-center justify-center rounded-xl text-sm font-bold transition-colors border border-slate-200 bg-white hover:bg-slate-50 hover:text-slate-900 h-10 px-5 shadow-sm text-slate-600 focus:outline-none focus:ring-2 focus:ring-slate-200 focus:ring-offset-2",
                                            children: [
                                                /* @__PURE__ */ jsx(
                                                    ChevronLeft,
                                                    {
                                        ...
                                        /* @__PURE__ */ jsxs("button", {
                                            ...
                                            className:
                                                "inline-flex flex-[2] md:flex-none items-center justify-center rounded-xl text-sm font-bold transition-all bg-orange-500 text-white hover:bg-orange-600 shadow-lg shadow-orange-500/20 h-10 px-6 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2",
                                            children: [
                                                /* @__PURE__ */ jsx(Plus, {
                                                    size: 16,
                                                    className: "mr-1.5",
                    ...
                    /* @__PURE__ */ jsx(Modal, {
                        ...
                        children: /* @__PURE__ */ jsxs("div", {
                            ...
                            children: [
                                /* @__PURE__ */ jsx("div", {
                                    className:
                                        "px-6 py-5 border-b border-zinc-100 flex items-center justify-between bg-zinc-50/50",
                                    children: /* @__PURE__ */ jsxs("div", {
                                        ...
                                        children: [
                                            ...
                                            /* @__PURE__ */ jsxs("div", {
                                                children: [
                                                    ...
                                                    /* @__PURE__ */ jsx("p", {
                                                        className:
                                                            "text-xs text-zinc-500 font-medium mt-0.5",
                                                        children:
                                                            "Atur preferensi makro dan hasilkan menu otomatis.",
                                                    }),
                                                ],
                                            }),
                                        ],
                                ...
                                /* @__PURE__ */ jsx("div", {
                                    ...
                                    children: /* @__PURE__ */ jsxs("div", {
                                        ...
                                        children: [
                                            /* @__PURE__ */ jsxs("div", {
                                                ...
                                                children: [
                                                    /* @__PURE__ */ jsxs(
                                                        ...
                                                        {
                                                            className:
                                                                "bg-zinc-50 p-5 rounded-2xl border border-zinc-200 flex flex-col",
                                                            children: [
                                                                /* @__PURE__ */ jsx(
                                                                    "label",
                                                                    {
                                                                        className:
                                                                            "block text-[11px] font-black text-zinc-500 uppercase tracking-widest mb-3",
                                                                        children:
                                                                            "1. Target Program",
                                                                    },
                                                                ),
                                                    ...
                                                    /* @__PURE__ */ jsxs(
                                                        ...
                                                        {
                                                            className:
                                                                "bg-zinc-50 p-5 rounded-2xl border border-zinc-200 flex gap-4",
                                                            children: [
                                                                /* @__PURE__ */ jsxs(
                                                                    "div",
                                                                    {
                                                                            ...
                                                                            [
                                                                                ...
                                                                                /* @__PURE__ */ jsx(
                                                                                    "input",
                                                                                    {
                                                                                        ...
                                                                                        className:
                                                                                            "w-full bg-white border border-zinc-200 focus:border-orange-500 focus:ring-1 focus:ring-orange-500 rounded-xl px-4 py-2.5 text-sm font-bold text-zinc-700 transition-colors shadow-sm",
                                                                                    },
                                                                                ),
                                                                            ],
                                                                    },
                                                                ...
                                                                /* @__PURE__ */ jsxs(
                                                                    ...
                                                                    {
                                                                        className:
                                                                            "w-36 shrink-0 bg-orange-500 text-white rounded-xl flex flex-col items-center justify-center p-3 shadow-lg shadow-orange-500/20",
                                                                        children:
                                                                            [
                                                                                /* @__PURE__ */ jsx(
                                                                                    "p",
                                                                                    {
                                                                                        className:
                                                                                            "text-[10px] font-bold uppercase tracking-wider text-orange-100 mb-1",
                                                                                        children:
                                                                                            "Target Kalori",
                                                                                    },
                                                                                ),
                                                                                ...
                                                                                /* @__PURE__ */ jsx(
                                                                                    ...
                                                                                    {
                                                                                        className:
                                                                                            "text-[9px] font-medium text-orange-100 mb-2",
                                                                                        children:
                                                                                            "kcal/hari",
                                                                                    },
                                                                                ),
                                                                                /* @__PURE__ */ jsx(
                                                                                    ...
                                                                                    {
                                                                                        className:
                                                                                            "w-full h-px bg-orange-400 mb-2",
                                                                                    },
                                                                                ),
                                                                                /* @__PURE__ */ jsx(
                                                                                    "p",
                                                                                ...
                                                                                /* @__PURE__ */ jsx(
                                                                                    ...
                                                                                    {
                                                                                        className:
                                                                                            "text-[9px] font-medium text-orange-200 mt-0.5",
                                                                                        children:
                                                                                            "kcal/minggu",
                                                                                    },
                                                                                ),
                                                    ...
                                                    children: [
                                                        ...
                                                        /* @__PURE__ */ jsx(
                                                            "p",
                                                            {
                                                                ...
                                                                children:
                                                                    "Atlet belum memiliki data Komposisi Tubuh. Tes diperlukan untuk kalkulasi TDEE akurat.",
                                                            },
                                                        ),
                                                    ],
                                                }),
                                            /* @__PURE__ */ jsxs("div", {
                                                className:
                                                    "bg-zinc-50 border border-zinc-200 rounded-2xl p-6 flex flex-col",
                                                children: [
                                                    /* @__PURE__ */ jsx(
                                                        "label",
                                                        {
                                                            className:
                                                                "block text-[11px] font-black text-zinc-500 uppercase tracking-widest mb-4",
                                                            children:
                                                    ...
                                                    startDate
                                                                      ...
                                                                      weekDays.map(
                                                                          (
                                                                              ...
                                                                              /* @__PURE__ */ jsxs(
                                                                                  ...
                                                                                  {
                                                                                      className:
                                                                                          "bg-white border border-zinc-200 rounded-xl p-4 flex flex-col items-center text-center shadow-sm hover:border-orange-300 transition-colors group",
                                                                                      children:
                                                                                          [
                                                                                              /* @__PURE__ */ jsx(
                                                                                                  "p",
                                                                                                  {
                                                                                                      className:
                                                                                                          "text-[10px] font-black text-zinc-400 uppercase tracking-widest group-hover:text-orange-500 transition-colors",
                                                                                                      children:
                                                                                                          day.label
                                                                                                              .split(
                                                                                                                  ",",
                                                                                              ...
                                                                                              /* @__PURE__ */ jsx(
                                                                                                  ...
                                                                                                  {
                                                                                                      className:
                                                                                                          "text-[14px] font-black text-zinc-800 mt-1 mb-3",
                                                                                                      children:
                                                                                                          day.label
                                                                                                              .split(
                                                                                                                  ",",
                                                                                                      ...
                                                                                                      children:
                                                                                                          /* @__PURE__ */ jsx(
                                                                                                              "select",
                                                                                                              {
                                                                                                                  ...
                                                                                                                  className:
                                                                                                                      "w-full bg-zinc-50 border border-zinc-200 rounded-lg text-[12px] font-bold text-zinc-700 py-2 pl-3 pr-8 cursor-pointer focus:border-orange-500 focus:ring-1 focus:ring-orange-500 focus:bg-white shadow-sm transition-all text-left",
                                                                                                                  children:
                                                                                                                      DIET_OPTIONS.map(
                                                                                                                          (
                                                                                                                              o,
                                                        ...
                                                        : /* @__PURE__ */ jsx(
                                                              ...
                                                              {
                                                                  className:
                                                                      "border border-dashed border-zinc-300 rounded-xl flex items-center justify-center bg-white p-8",
                                                                  children:
                                                                      /* @__PURE__ */ jsx(
                                                                          "p",
                                                                          {
                                                                              className:
                                                                                  "text-sm text-zinc-400 font-medium text-center",
                                                                              children:
                                                ...
                                                children: [
                                                    /* @__PURE__ */ jsx(
                                                        "button",
                                                        {
                                                            ...
                                                            className:
                                                                "px-6 py-3 bg-zinc-100 hover:bg-zinc-200 text-zinc-700 font-bold rounded-xl transition-all text-sm",
                                                            children: "Batal",
                                                        },
                                                    ),
                                                    /* @__PURE__ */ jsxs(
                                                        "button",
                                                        {
                                                            ...
                                                            disabled:
                                                                ...
                                                                !startDate,
                                                            className:
                                                                "px-8 py-3 bg-orange-500 hover:bg-orange-600 text-white font-bold rounded-xl shadow-sm transition-all disabled:opacity-50 flex items-center justify-center gap-2 text-sm",
                                                            children: [
                                                                /* @__PURE__ */ jsx(
                                                                    Target,
                                                                    {
                    ...
                    planToDisplay && !isDraft
                        ? /* @__PURE__ */ jsxs("div", {
                              ...
                              children: [
                                  ...
                                  !isAthlete &&
                                      ...
                                      /* @__PURE__ */ jsx("div", {
                                          className:
                                              "pt-4 pb-12 flex justify-center",
                                          children: /* @__PURE__ */ jsxs(
                                              "button",
                                              {
                                                  ...
                                                  className:
                                                      "py-2.5 px-4 text-xs text-red-500 hover:text-red-700 hover:bg-red-50 font-bold flex items-center justify-center gap-2 rounded-xl transition-all",
                                                  children: [
                                                      /* @__PURE__ */ jsx(
                                                          Trash2,
                                                          { size: 14 },
                        ...
                        : !isDraft &&
                          /* @__PURE__ */ jsxs("div", {
                              className:
                                  "bg-white rounded-2xl border border-zinc-200 py-24 flex flex-col items-center justify-center shadow-sm mt-8",
                              children: [
                                  /* @__PURE__ */ jsx("div", {
                                      className:
                                          "w-20 h-20 bg-zinc-50 border border-zinc-200 rounded-full flex items-center justify-center mb-6",
                                  ...
                                  /* @__PURE__ */ jsx("h3", {
                                      ...
                                      children: "Belum Ada Rencana Makan",
                                  }),
                                  /* @__PURE__ */ jsx("p", {
                                      className:
                                          "text-zinc-500 mt-2 max-w-sm text-center text-sm font-medium",
                                      children: isAthlete
                    ...
                    /* @__PURE__ */ jsx(Modal, {
                        ...
                        children: /* @__PURE__ */ jsxs("div", {
                            ...
                            children: [
                                /* @__PURE__ */ jsxs("div", {
                                    className:
                                        "bg-gradient-to-r from-orange-500 to-orange-600 p-6 md:p-8 shrink-0 text-white flex flex-col md:flex-row items-center justify-between gap-6 relative overflow-hidden z-20",
                                    children: [
                                        /* @__PURE__ */ jsx("div", {
                                            className:
                                                "absolute top-0 right-0 w-64 h-64 bg-white opacity-5 rounded-full -mr-20 -mt-20 pointer-events-none",
                                        }),
                                        /* @__PURE__ */ jsxs("div", {
                                            className:
                                            ...
                                            children: [
                                                /* @__PURE__ */ jsx("div", {
                                                    className:
                                                        "p-2.5 bg-white/20 text-white rounded-xl backdrop-blur-sm",
                                                    children:
                                                        /* @__PURE__ */ jsx(
                                                            Info,
                                                            { size: 24 },
                                                ...
                                                /* @__PURE__ */ jsxs("div", {
                                                    children: [
                                                            ...
                                                            "h3",
                                                            {
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /* @__PURE__ */ jsx(
                                                                        ...
                                                                        {
                                                                            className:
                                                                                "px-2.5 py-1 rounded-md text-[10px] font-bold bg-white text-orange-600 uppercase tracking-widest shadow-sm",
                                                                            children:
                                                                                "Unsaved",
                                                                        },
                                                                    ),
                                                        ...
                                                        /* @__PURE__ */ jsx(
                                                            ...
                                                            {
                                                                className:
                                                                    "text-sm font-medium text-orange-50 mt-1.5",
                                                                children:
                                                                    "Periksa jadwal di bawah. Klik ikon putar (↻) pada bahan spesifik untuk menggantinya secara otomatis.",
                                                            },
                                                        ),
                                                    ],
                                                }),
                                        ...
                                        /* @__PURE__ */ jsxs("div", {
                                            className:
                                                "flex gap-3 w-full md:w-auto shrink-0 relative z-10",
                                            children: [
                                                /* @__PURE__ */ jsx("button", {
                                                    onClick: () =>
                                                        setDraftPlan(null),
                                                    className:
                                                        "flex-1 md:flex-none px-6 py-3 bg-white/10 hover:bg-white/20 text-white rounded-xl font-bold transition-all text-sm backdrop-blur-sm border border-white/20",
                                                    children: "Batal",
                                                }),
                                                /* @__PURE__ */ jsxs("button", {
                                                    onClick: handleSavePlan,
                                                    className:
                                                        "flex-1 md:flex-none px-6 py-3 bg-white hover:bg-orange-50 text-orange-600 rounded-xl font-black transition-all flex items-center justify-center gap-2 text-sm shadow-sm",
                                                    children: [
                                                        /* @__PURE__ */ jsx(
                                                            Save,
                                                            { size: 18 },
                                ...
                                /* @__PURE__ */ jsx("div", {
                                    className:
                                        "p-6 md:p-8 overflow-y-auto bg-zinc-50/50 flex-1 min-h-0",
