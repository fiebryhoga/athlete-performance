...
import { Search, X, Filter, ChevronDown, Plus, Dumbbell, Copy, Pencil, Trash2, ArrowUpRight, Save, AlertTriangle, Check } from "lucide-react";
...
function Index({ sports }) {
  ...
  const submit = (e) => {
    e.preventDefault();
    post(route("admin.sports.store"), { onSuccess: () => {
      reset();
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: "Kategori Olahraga", children: [
    /* @__PURE__ */ jsx(Head, { title: "Kategori Olahraga" }),
    /* @__PURE__ */ jsxs("div", { className: "space-y-4 pb-6", children: [
      ...
      filteredSports.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "col-span-full py-16 px-4 flex flex-col items-center justify-center bg-white border border-dashed border-slate-200 rounded-xl text-center space-y-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsx("h4", { className: "text-sm font-bold text-slate-800", children: "No Sports Categories Found" }),
          /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400 font-medium max-w-sm", children: "Please add new data to get started." })
        ] })
      ] }) : /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3.5", children: filteredSports.map((sport) => /* @__PURE__ */ jsxs(
        Link,
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "p-3.5 space-y-3 flex-1 flex flex-col justify-between", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2.5", children: [
                /* @__PURE__ */ jsx("div", { className: "w-10 h-10 sm:w-11 sm:h-11 rounded-md border-2 border-white shadow-2xs bg-gradient-to-br from-orange-50 to-orange-100/70 text-orange-600 font-black text-base flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(Dumbbell, { className: "w-5 h-5" }) }),
                /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1 space-y-0.5", children: [
                  /* @__PURE__ */ jsx("h3", { className: "font-bold text-slate-900 text-xs sm:text-[13px] truncate group-hover:text-orange-600 transition-colors leading-tight", children: sport.name }),
                  /* @__PURE__ */ jsx("p", { className: "text-[11px] text-slate-500 font-medium truncate line-clamp-1", children: sport.description || "Tidak ada deskripsi" })
                ] })
              ] }),
              isSuperadmin && /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 pt-1", children: [
                /* @__PURE__ */ jsx("button", { onClick: (e) => openDuplicateModal(e, sport), className: "p-1 rounded text-slate-400 hover:text-blue-500 hover:bg-blue-50 transition-all z-10 relative", title: "Duplicate", children: /* @__PURE__ */ jsx(Copy, { className: "w-3 h-3" }) }),
                /* @__PURE__ */ jsx("button", { onClick: (e) => openEditModal(e, sport), className: "p-1 rounded text-slate-400 hover:text-emerald-500 hover:bg-emerald-50 transition-all z-10 relative", title: "Edit", children: /* @__PURE__ */ jsx(Pencil, { className: "w-3 h-3" }) }),
                /* @__PURE__ */ jsx("button", { onClick: (e) => openDeleteModal(e, sport), className: "p-1 rounded text-slate-400 hover:text-rose-500 hover:bg-rose-50 transition-all z-10 relative", title: "Delete", children: /* @__PURE__ */ jsx(Trash2, { className: "w-3 h-3" }) })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-1.5 pt-0.5 border-t border-slate-100/90", children: [
                /* @__PURE__ */ jsxs("div", { className: "p-1.5 bg-white/90 rounded-md border border-slate-200/70 shadow-2xs", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[8px] font-bold text-slate-400 uppercase tracking-wider block", children: "Athletes" }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-0.5 mt-0.5", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[11.5px] font-black text-orange-600 leading-tight", children: sport.athletes_count }),
                    /* @__PURE__ */ jsx("span", { className: "text-[8px] font-normal text-slate-400", children: "orang" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "p-1.5 bg-white/90 rounded-md border border-slate-200/70 shadow-2xs", children: [
                  /* @__PURE__ */ jsx("span", { className: "text-[8px] font-bold text-slate-400 uppercase tracking-wider block", children: "Tests" }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-0.5 mt-0.5", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[11.5px] font-black text-teal-700 leading-tight", children: sport.test_items_count }),
                    /* @__PURE__ */ jsx("span", { className: "text-[8px] font-normal text-slate-400", children: "item" })
                  ] })
                ] })
              ] })
            ] }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative bg-white w-full max-w-md rounded-lg shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200", children: [
        /* @__PURE__ */ jsxs("div", { className: "px-6 py-5 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-slate-800", children: "Tambah Cabor" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-500 font-medium mt-0.5", children: "Daftarkan cabang olahraga baru." })
          ] }),
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "p-6 space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-[10px] font-bold text-slate-400 mb-1.5", children: "Nama Cabor" }),
            /* @__PURE__ */ jsx("input", { type: "text", value: data.name, onChange: (e) => setData("name", e.target.value), className: "w-full rounded-lg border-slate-200 focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 text-sm py-2.5 placeholder-slate-400 transition-all outline-none", placeholder: "Contoh: Basketball, Swimming...", autoFocus: true }),
            errors.name && /* @__PURE__ */ jsx("p", { className: "text-rose-500 text-xs mt-1 font-bold", children: errors.name })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-[10px] font-bold text-slate-400 mb-1.5", children: "Deskripsi (Opsional)" }),
            /* @__PURE__ */ jsx("textarea", { value: data.description, onChange: (e) => setData("description", e.target.value), className: "w-full rounded-lg border-slate-200 focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 text-sm py-2.5 min-h-[100px] placeholder-slate-400 resize-none transition-all outline-none custom-scrollbar", placeholder: "Deskripsi singkat tentang cabor ini..." })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-3 pt-6 mt-2 border-t border-slate-100", children: [
            /* @__PURE__ */ jsx("button", { type: "button", onClick: () => {
              setIsModalOpen(false);
              reset();
            }, className: "px-5 py-2.5 text-slate-500 font-bold text-sm hover:bg-slate-100 rounded-lg transition-colors", children: "Batal" }),
            /* @__PURE__ */ jsxs("button", { type: "submit", disabled: processing, className: "px-6 py-2.5 bg-orange-500 text-white font-bold text-sm rounded-lg hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/20 disabled:opacity-70 flex items-center gap-2", children: [
    ...
    isDuplicateModalOpen && selectedSport && /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-[60] flex items-center justify-center p-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative bg-white w-full max-w-md rounded-lg shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200", children: [
        /* @__PURE__ */ jsxs("div", { className: "px-6 py-5 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-slate-800", children: "Duplikat Cabor" }),
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: handleDuplicateSubmit, className: "p-6 space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-[10px] font-bold text-slate-400 mb-1.5", children: "Nama Cabor Baru" }),
            /* @__PURE__ */ jsx("input", { type: "text", value: duplicateForm.data.name, onChange: (e) => duplicateForm.setData("name", e.target.value), className: "w-full rounded-lg border-slate-200 focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 text-sm py-2.5 placeholder-slate-400 transition-all outline-none", placeholder: "Masukkan nama unik...", autoFocus: true }),
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-3 pt-6 mt-2 border-t border-slate-100", children: [
            ...
            /* @__PURE__ */ jsxs("button", { type: "submit", disabled: duplicateForm.processing, className: "px-6 py-2.5 bg-orange-500 text-white font-bold text-sm rounded-lg hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/20 disabled:opacity-70 flex items-center gap-2", children: [
    ...
    isEditModalOpen && selectedSport && /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-[60] flex items-center justify-center p-4", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative bg-white w-full max-w-md rounded-lg shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200", children: [
        /* @__PURE__ */ jsxs("div", { className: "px-6 py-5 border-b border-slate-100 bg-slate-50/50 flex justify-between items-center", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("h3", { className: "text-lg font-bold text-slate-800", children: "Edit Cabor" }),
            /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-500 font-medium mt-0.5", children: "Perbarui detail cabang olahraga." })
          ] }),
          /* @__PURE__ */ jsx("button", { onClick: () => {
            setIsEditModalOpen(false);
            editForm.reset();
        ...
        /* @__PURE__ */ jsxs("form", { onSubmit: handleEditSubmit, className: "p-6 space-y-5", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-[10px] font-bold text-slate-400 mb-1.5", children: "Nama Cabor" }),
            /* @__PURE__ */ jsx("input", { type: "text", value: editForm.data.name, onChange: (e) => editForm.setData("name", e.target.value), className: "w-full rounded-lg border-slate-200 focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 text-sm py-2.5 placeholder-slate-400 transition-all outline-none", autoFocus: true }),
            editForm.errors.name && /* @__PURE__ */ jsx("p", { className: "text-rose-500 text-xs mt-1 font-bold", children: editForm.errors.name })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx("label", { className: "block text-[10px] font-bold text-slate-400 mb-1.5", children: "Deskripsi (Opsional)" }),
            /* @__PURE__ */ jsx("textarea", { value: editForm.data.description, onChange: (e) => editForm.setData("description", e.target.value), className: "w-full rounded-lg border-slate-200 focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 text-sm py-2.5 min-h-[100px] placeholder-slate-400 resize-none transition-all outline-none custom-scrollbar" })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex justify-end gap-3 pt-6 mt-2 border-t border-slate-100", children: [
            /* @__PURE__ */ jsx("button", { type: "button", onClick: () => {
              setIsEditModalOpen(false);
            ...
            /* @__PURE__ */ jsxs("button", { type: "submit", disabled: editForm.processing, className: "px-6 py-2.5 bg-orange-500 text-white font-bold text-sm rounded-lg hover:bg-orange-600 transition-colors shadow-lg shadow-orange-500/20 disabled:opacity-70 flex items-center gap-2", children: [
    ...
    isDeleteModalOpen && selectedSport && /* @__PURE__ */ jsxs("div", { className: "fixed inset-0 z-[70] flex items-center justify-center p-4", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "relative bg-white w-full max-w-md rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200", children: /* @__PURE__ */ jsxs("div", { className: "p-6 text-center", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsx("button", { onClick: () => setIsDeleteModalOpen(false), className: "flex-1 py-3 text-slate-600 font-bold text-sm bg-slate-100 hover:bg-slate-200 rounded-xl transition-colors", children: "Batalkan" }),
          /* @__PURE__ */ jsx("button", { onClick: confirmDelete, className: "flex-1 py-3 bg-rose-500 text-white font-bold text-sm rounded-xl hover:bg-rose-600 transition-all shadow-lg shadow-rose-500/30 hover:shadow-rose-500/40 active:scale-95", children: "Ya, Hapus Permanen" })
        ] })
      ] }) })
    ] })
  ] });
