...
import { Search, X, Filter, ChevronDown, Calendar, ArrowUpRight, Check } from "lucide-react";
import "axios";
...
function Index({ athletes = [], filters = {}, sports = [] }) {
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-4 pb-6", children: [
          ...
          filteredAthletes.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "col-span-full py-16 px-4 flex flex-col items-center justify-center bg-white border border-dashed border-slate-200 rounded-xl text-center space-y-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
              ...
              /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400 font-medium max-w-sm", children: "Coba ubah kata kunci pencarian atau atur ulang filter." })
            ] }),
            activeFilterCount > 0 && /* @__PURE__ */ jsx(
              "button",
              {
            ...
            const photo = athlete.photo_url || athlete.profile_photo_url || athlete.profile_photo;
            return /* @__PURE__ */ jsxs(
              Link,
              {
                href: route(
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "p-3.5 space-y-3 flex-1 flex flex-col justify-between", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2.5", children: [
                      ...
                      /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1 space-y-0.5", children: [
                        ...
                        /* @__PURE__ */ jsx("p", { className: "text-[11px] text-slate-500 font-medium truncate", children: athlete.sport?.name || "Klien" })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsx("div", { children: athlete.latest_plan ? /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between bg-white/80 px-2 py-1 rounded border border-slate-200/70 text-[9.5px]", children: [
                      ...
                      /* @__PURE__ */ jsx("strong", { className: "text-slate-700 font-bold", children: new Date(
                        athlete.latest_plan.created_at
                      ).toLocaleDateString(
                        "id-ID",
                        {
                          day: "2-digit",
                    ...
                    ] }) : /* @__PURE__ */ jsx("div", { className: "bg-white/60 px-2 py-1 rounded border border-dashed border-slate-200 text-[9.5px] text-slate-400 font-medium text-center", children: "Belum ada rencana makan" }) }),
                    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-1.5 pt-0.5 border-t border-slate-100/90", children: [
                      /* @__PURE__ */ jsxs("div", { className: "p-1.5 bg-white/90 rounded-md border border-slate-200/70 shadow-2xs", children: [
                        /* @__PURE__ */ jsx("span", { className: "text-[8px] font-bold text-slate-400 uppercase tracking-wider block", children: "Total" }),
                        /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-0.5 mt-0.5", children: [
                          /* @__PURE__ */ jsx("span", { className: "text-[11.5px] font-black text-orange-600 leading-tight", children: athlete.total_plans || 0 }),
                          /* @__PURE__ */ jsx("span", { className: "text-[8px] font-normal text-slate-400", children: "rencana" })
                        ] })
                      ] }),
                      /* @__PURE__ */ jsxs("div", { className: "p-1.5 bg-white/90 rounded-md border border-slate-200/70 shadow-2xs", children: [
                        ...
                        /* @__PURE__ */ jsx("div", { className: "mt-0.5", children: /* @__PURE__ */ jsx(
                          "span",
                          {
                            className: `text-[9.5px] font-black leading-tight block truncate ${athlete.total_plans > 0 ? "text-emerald-600" : "text-slate-400"}`,
                            children: athlete.total_plans > 0 ? "Aktif" : "Belum Ada"
                          }
                        ) })
                      ] })
                    ] })
