...
import { Scale, Ruler, Activity, Flame, Shield, HeartPulse, Dumbbell, Layers, Droplets, Zap, User, Minus, TrendingUp, TrendingDown } from "lucide-react";
function TrendHighlights({ history }) {
  ...
  const getTrendInfo = (currVal, prevVal, inverse = false) => {
    if (currVal === void 0 || currVal === null || prevVal === void 0 || prevVal === null || currVal === "" || prevVal === "") {
      return {
        icon: Minus,
    ...
    if (deltaNum > 0) {
      ...
      return {
        icon: TrendingUp,
        badgeClass: isGood ? "bg-emerald-50 text-emerald-600 border-emerald-200/80" : "bg-rose-50 text-rose-600 border-rose-200/80",
        text: `+${delta}`,
        prevValue: prevVal,
        hasComparison: true
      };
  ...
  const filteredMetrics = selectedCategory === "all" ? allMetrics : allMetrics.filter((m) => m.category === selectedCategory);
  return /* @__PURE__ */ jsxs("div", { className: "space-y-2.5", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2.5 bg-white px-3.5 py-2.5 rounded-lg border border-slate-200/80 shadow-2xs", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        ...
        /* @__PURE__ */ jsxs("p", { className: "text-[10.5px] text-slate-400 font-medium mt-0.5", children: [
          "Evaluasi tes terbaru (",
          formatShortDate(current.date),
          ")"
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex items-center gap-1 overflow-x-auto max-w-full pb-0.5", children: categories.map((cat) => {
        ...
        return /* @__PURE__ */ jsx(
          "button",
          {
            ...
            className: `px-2 py-0.5 rounded text-[10.5px] font-bold transition-all shrink-0 ${isActive ? "bg-orange-500 text-white shadow-2xs" : "bg-slate-50 hover:bg-slate-100 text-slate-600 border border-slate-200/60"}`,
            children: cat.label
          },
          cat.id
        );
    ...
    /* @__PURE__ */ jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2", children: filteredMetrics.map((metric) => {
      const MetricIcon = metric.icon;
      const TrendIcon = metric.trend.icon;
      const hasVal = metric.value !== null && metric.value !== void 0 && metric.value !== "";
      return /* @__PURE__ */ jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1.5 min-w-0", children: [
              /* @__PURE__ */ jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsx(MetricIcon, { className: "w-2.5 h-2.5" })
                }
              ),
              /* @__PURE__ */ jsx(
                "h4",
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-1 my-0.5", children: [
              /* @__PURE__ */ jsx("span", { className: "text-base sm:text-[17px] font-black text-slate-900 tracking-tight leading-none", children: hasVal ? metric.value : "-" }),
              hasVal && metric.unit && /* @__PURE__ */ jsx("span", { className: "text-[9px] font-bold text-slate-400", children: metric.unit })
            ] }),
            /* @__PURE__ */ jsx("div", { className: "pt-1.5 border-t border-slate-100 flex items-center justify-between text-[9px] text-slate-400 font-medium leading-none", children: previous && metric.trend.hasComparison ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 w-full justify-between", children: [
              /* @__PURE__ */ jsxs(
                "div",
                {
                  className: `inline-flex items-center gap-0.5 font-bold px-1 py-0.2 rounded border text-[8.5px] ${metric.trend.badgeClass}`,
                  children: [
                    /* @__PURE__ */ jsx(TrendIcon, { className: "w-2 h-2" }),
                    /* @__PURE__ */ jsx("span", { children: metric.trend.text })
                  ]
                }
              ),
              /* @__PURE__ */ jsxs("span", { className: "truncate text-slate-400", children: [
                "vs ",
                metric.trend.prevValue,
                " ",
                metric.unit
              ] })
            ] }) : /* @__PURE__ */ jsx("span", { children: previous ? "Tidak ada perbandingan" : "Data pertama" }) })
          ]
        },
        metric.id
      );
