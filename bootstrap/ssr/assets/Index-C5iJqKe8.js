...
function Index({ athletes = [], sports = [] }) {
  ...
  const filteredAthletes = useMemo(() => {
    return (athletes || []).filter((athlete) => {
      ...
      if (sortBy === "sessions_desc")
        return (b.load_session_count || 0) - (a.load_session_count || 0);
      return 0;
    });
  ...
  return /* @__PURE__ */ jsxs(
    AppLayout,
    {
      ...
      description: "Pantau volume load, progressive overload, dan distribusi beban latihan kekuatan per atlet.",
      children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-1.5 pt-0.5 border-t border-slate-100/90", children: [
                      /* @__PURE__ */ jsxs("div", { className: "p-1.5 bg-white/90 rounded-md border border-slate-200/70 shadow-2xs", children: [
                        ...
                        /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-0.5 mt-0.5", children: [
                          /* @__PURE__ */ jsx("span", { className: "text-[11.5px] font-black text-orange-600 leading-tight", children: athlete.load_session_count || 0 }),
