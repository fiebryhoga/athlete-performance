...
import { Calendar, Download, ChevronLeft, ChevronRight, Plus, Copy, Edit2, Trash2, CheckCircle2, Clock, Dumbbell, MapPin, Timer, X } from "lucide-react";
import "axios";
function ShowGroup({ auth, group, trainings, groupTrainings }) {
  ...
  const expDate = group.training_exp_date ? new Date(group.training_exp_date).toLocaleDateString("id-ID", { day: "numeric", month: "short", year: "numeric" }) : null;
  const packageBadge = group.package ? `Paket: ${group.package.name} (Sesi ${maxSession}/${group.package.session_count})${expDate ? ` • Masa Aktif Sampai ${expDate}` : ""}` : "Tidak Ada Paket";
  return /* @__PURE__ */ jsxs(AppLayout, { title: `Kalender Latihan - ${group.name}`, children: [
    /* @__PURE__ */ jsx(Head, { title: `Kalender Latihan - ${group.name}` }),
    /* @__PURE__ */ jsx(
      PageHeader,
      {
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mb-1.5", children: [
                ...
                auth.user.role !== "group" && /* @__PURE__ */ jsx(
                  Link,
                  {
                      ...
                      Link,
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxs("div", { className: "flex items-start justify-between mb-2", children: [
                            session.is_extra ? /* @__PURE__ */ jsx("span", { className: `text-[10px] font-bold px-1.5 py-0.5 rounded bg-indigo-100 text-indigo-700 border border-indigo-200`, children: "Sesi Tambahan" }) : /* @__PURE__ */ jsxs("span", { className: `text-[10px] font-bold px-1.5 py-0.5 rounded ${badgeBgColor}`, children: [
                              "Sesi ",
                              session.session_number,
                              "/",
                              group.package?.session_count || "∞"
                            ] }),
                            /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1", children: [
                              ...
                              session.status === "completed" || session.is_completed ? /* @__PURE__ */ jsx(CheckCircle2, { size: 14, className: "text-purple-600 ml-0.5 mr-1" }) : /* @__PURE__ */ jsx(Clock, { size: 14, className: "text-indigo-500 ml-0.5 mr-1" })
                            ] })
                          ] }),
    ...
    duplicateModalOpen && sessionToDuplicate && /* @__PURE__ */ jsx("div", { className: "fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4", children: /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-xl shadow-xl w-full max-w-md overflow-hidden", children: [
      /* @__PURE__ */ jsxs("div", { className: "px-6 py-4 border-b border-slate-100 flex items-center justify-between", children: [
        /* @__PURE__ */ jsx("h3", { className: "font-bold text-slate-800", children: "Duplikasi Sesi Latihan Grup" }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "p-6 space-y-4", children: [
        /* @__PURE__ */ jsxs("div", { className: "bg-slate-50 border border-slate-200 rounded-lg p-3", children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-sm font-bold text-slate-800", children: [
            "[GRUP] ",
            sessionToDuplicate.name || group.name
          ] }),
