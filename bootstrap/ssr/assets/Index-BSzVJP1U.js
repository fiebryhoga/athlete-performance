...
import { Search, X, Filter, ChevronDown, User, Users, ArrowUpRight, Check } from "lucide-react";
import "axios";
...
function Index({ athletes = [], groups = [], sports = [] }) {
  ...
  return /* @__PURE__ */ jsxs(
    AppLayout,
    {
      title: "Recovery Strategi",
      description: "Pilih athlete atau grup untuk menjadwalkan strategi pemulihan (recovery) mereka.",
      children: [
        /* @__PURE__ */ jsx(Head, { title: "Recovery Strategi" }),
        /* @__PURE__ */ jsxs("div", { className: "space-y-4 pb-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "flex space-x-0.5 bg-white/80 p-0.5 rounded-lg border border-slate-200 w-fit", children: [
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                className: `px-3.5 py-1.5 text-xs font-bold rounded-md transition-all flex items-center gap-1.5 cursor-pointer ${activeTab === "individual" ? "bg-gradient-to-b from-white via-orange-50/20 to-orange-100/30 text-orange-600 border border-slate-200/90 shadow-2xs" : "text-slate-500 hover:text-slate-700 hover:bg-slate-50"}`,
                children: [
            ...
            /* @__PURE__ */ jsxs(
              "button",
              {
                ...
                className: `px-3.5 py-1.5 text-xs font-bold rounded-md transition-all flex items-center gap-1.5 cursor-pointer ${activeTab === "group" ? "bg-gradient-to-b from-white via-orange-50/20 to-orange-100/30 text-orange-600 border border-slate-200/90 shadow-2xs" : "text-slate-500 hover:text-slate-700 hover:bg-slate-50"}`,
                children: [
          ...
          activeTab === "individual" ? /* @__PURE__ */ jsx(Fragment, { children: filteredAthletes.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "col-span-full py-16 px-4 flex flex-col items-center justify-center bg-white border border-dashed border-slate-200 rounded-xl text-center space-y-3", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
              /* @__PURE__ */ jsx("h4", { className: "text-sm font-bold text-slate-800", children: "Tidak ada Athlete ditemukan" }),
              /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400 font-medium max-w-sm", children: "Ubah kata kunci pencarian Anda atau pastikan data athlete tersedia." })
            ] }),
            activeFilterCount > 0 && /* @__PURE__ */ jsx(
              "button",
              {
            ...
            return /* @__PURE__ */ jsxs(
              ...
              {
                href: route(
                  "admin.recovery-strategies.show",
                  athlete.id
                ),
                ...
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "p-3.5 space-y-3 flex-1 flex flex-col justify-between", children: [
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-1.5 pt-0.5 border-t border-slate-100/90", children: [
                      /* @__PURE__ */ jsxs("div", { className: "p-1.5 bg-white/90 rounded-md border border-slate-200/70 shadow-2xs", children: [
                        /* @__PURE__ */ jsx("span", { className: "text-[8px] font-bold text-slate-400 uppercase tracking-wider block", children: "Role" }),
                        /* @__PURE__ */ jsx("div", { className: "mt-0.5", children: /* @__PURE__ */ jsx("span", { className: "text-[9.5px] font-bold text-slate-700 leading-tight block truncate capitalize", children: athlete.role || "-" }) })
                      ] }),
                      /* @__PURE__ */ jsxs("div", { className: "p-1.5 bg-white/90 rounded-md border border-slate-200/70 shadow-2xs", children: [
                        /* @__PURE__ */ jsx("span", { className: "text-[8px] font-bold text-slate-400 uppercase tracking-wider block", children: "Cabor" }),
                        /* @__PURE__ */ jsx("div", { className: "mt-0.5", children: /* @__PURE__ */ jsx("span", { className: "text-[9.5px] font-bold text-slate-700 leading-tight block truncate", children: athlete.sport?.name || "-" }) })
                      ] })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "px-3.5 py-2 bg-gradient-to-r from-slate-50/90 via-white to-orange-50/30 border-t border-slate-100 flex items-center justify-between text-xs", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[9.5px] font-bold text-slate-500 capitalize", children: athlete.role || "Athlete" }),
            ...
            /* ─── GROUP TAB ─── */
            /* @__PURE__ */ jsx(Fragment, { children: filteredGroups.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "col-span-full py-16 px-4 flex flex-col items-center justify-center bg-white border border-dashed border-slate-200 rounded-xl text-center space-y-3", children: [
              /* @__PURE__ */ jsx("div", { className: "w-12 h-12 rounded-full bg-orange-50 border border-orange-200/60 flex items-center justify-center text-orange-500 shadow-2xs", children: /* @__PURE__ */ jsx(Users, { className: "w-5 h-5" }) }),
              /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
                /* @__PURE__ */ jsx("h4", { className: "text-sm font-bold text-slate-800", children: "Tidak ada Grup ditemukan" }),
                /* @__PURE__ */ jsx("p", { className: "text-xs text-slate-400 font-medium max-w-sm", children: "Buat grup baru di menu Manajemen Pengguna terlebih dahulu." })
              ] })
            ] }) : /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3.5", children: filteredGroups.map((group) => /* @__PURE__ */ jsxs(
              Link,
              {
                href: route(
                  "admin.recovery-strategies.group.show",
                  group.id
                ),
                className: "group relative bg-gradient-to-b from-white via-orange-50/20 to-orange-100/30 rounded-lg border border-slate-200/90 hover:border-orange-200/80 shadow-2xs hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 flex flex-col justify-between overflow-hidden",
                children: [
                  /* @__PURE__ */ jsxs("div", { className: "p-3.5 space-y-3 flex-1 flex flex-col justify-between", children: [
                    /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2.5", children: [
                      /* @__PURE__ */ jsx("div", { className: "w-10 h-10 sm:w-11 sm:h-11 rounded-md border-2 border-white shadow-2xs bg-gradient-to-br from-orange-50 to-orange-100/70 text-orange-600 font-black text-base flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsx(Users, { className: "w-5 h-5" }) }),
                      /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1 space-y-0.5", children: [
                        /* @__PURE__ */ jsx("h3", { className: "font-bold text-slate-900 text-xs sm:text-[13px] truncate group-hover:text-orange-600 transition-colors leading-tight", children: group.name }),
                        /* @__PURE__ */ jsx("p", { className: "text-[11px] text-slate-500 font-medium truncate", children: group.package?.name || "Tidak ada paket" })
                      ] })
                    ] }),
                    group.members && group.members.length > 0 && /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap gap-1", children: [
                      ...
                      group.members.length > 4 && /* @__PURE__ */ jsxs("span", { className: "inline-flex items-center px-1.5 py-0.5 rounded text-[8px] font-bold bg-orange-50 border border-orange-200/70 text-orange-600", children: [
                        "+",
                    ...
                    /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-1.5 pt-0.5 border-t border-slate-100/90", children: [
                      /* @__PURE__ */ jsxs("div", { className: "p-1.5 bg-white/90 rounded-md border border-slate-200/70 shadow-2xs", children: [
                        /* @__PURE__ */ jsx("span", { className: "text-[8px] font-bold text-slate-400 uppercase tracking-wider block", children: "Anggota" }),
                        /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-0.5 mt-0.5", children: [
                          /* @__PURE__ */ jsx("span", { className: "text-[11.5px] font-black text-orange-600 leading-tight", children: group.members?.length || 0 }),
                          /* @__PURE__ */ jsx("span", { className: "text-[8px] font-normal text-slate-400", children: "orang" })
                        ] })
                      ] }),
                      /* @__PURE__ */ jsxs("div", { className: "p-1.5 bg-white/90 rounded-md border border-slate-200/70 shadow-2xs", children: [
                        /* @__PURE__ */ jsx("span", { className: "text-[8px] font-bold text-slate-400 uppercase tracking-wider block", children: "Paket" }),
                        /* @__PURE__ */ jsx("div", { className: "mt-0.5", children: /* @__PURE__ */ jsx("span", { className: "text-[9.5px] font-bold text-slate-700 leading-tight block truncate", children: group.package?.name || "-" }) })
                      ] })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "px-3.5 py-2 bg-gradient-to-r from-slate-50/90 via-white to-orange-50/30 border-t border-slate-100 flex items-center justify-between text-xs", children: [
