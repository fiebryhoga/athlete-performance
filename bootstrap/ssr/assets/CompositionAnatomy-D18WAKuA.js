...
function CompositionAnatomy({ test, player }) {
  if (!test) return null;
  ...
  if (isNaN(muscle) || muscle <= 0) {
    if (!isNaN(ffm) && ffm > 0) {
      ...
      bone = isNaN(bone) || bone <= 0 ? parseFloat((ffm * 0.12).toFixed(1)) : bone;
      ...
      bone = isNaN(bone) || bone <= 0 ? parseFloat((estimatedFfm * 0.12).toFixed(1)) : bone;
    } else {
      muscle = parseFloat((w * 0.45).toFixed(1));
      bone = isNaN(bone) || bone <= 0 ? parseFloat((w * 0.08).toFixed(1)) : bone;
    }
  }
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx("div", { className: "flex items-center justify-between pb-2 border-b border-slate-100", children: /* @__PURE__ */ jsxs("div", { children: [
          /* @__PURE__ */ jsxs("h3", { className: "text-xs font-bold text-slate-900 flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx(User, { className: "w-3.5 h-3.5 text-orange-500" }),
            "Distribusi Anatomi Komposisi Tubuh"
          ] }),
          /* @__PURE__ */ jsxs("p", { className: "text-[11px] text-slate-400 font-medium mt-0.5", children: [
            "Proporsi komponen anatomis berdasarkan total berat badan atlet (",
            w,
            " kg)."
          ] })
        ] }) }),
        /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row items-center sm:items-stretch w-full mx-auto min-h-[340px] gap-4 flex-1", children: [
          /* @__PURE__ */ jsxs("div", { className: "relative w-[130px] sm:w-[150px] md:w-[170px] h-[320px] sm:h-full shrink-0 flex items-center justify-center bg-slate-50/50 rounded-xl border border-slate-100 p-2 overflow-hidden group", children: [
            /* @__PURE__ */ jsx(
              "img",
              {
                src: imgUrl,
          ...
          /* @__PURE__ */ jsx("div", { className: "hidden sm:block w-[30px] md:w-[45px] relative shrink-0 pointer-events-none h-full self-stretch", children: /* @__PURE__ */ jsx(
            "svg",
            {
              viewBox: "0 0 100 100",
              preserveAspectRatio: "none",
              className: "absolute inset-0 w-full h-full",
              children: sections.map((sec) => /* @__PURE__ */ jsx(
                "path",
                {
          ...
          /* @__PURE__ */ jsx("div", { className: "flex-1 w-full flex flex-col justify-between self-stretch space-y-2 py-0.5", children: sections.map((sec) => /* @__PURE__ */ jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxs("div", { className: "flex-1 flex items-center justify-between min-w-0", children: [
                  /* @__PURE__ */ jsx("span", { className: "font-bold text-slate-800 text-[11px] sm:text-xs truncate", children: sec.label }),
                  /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-0.5 shrink-0 ml-2", children: [
                    /* @__PURE__ */ jsx("span", { className: "font-black text-slate-900 text-xs sm:text-sm", children: sec.weight.toFixed(1) }),
