...
function DpaIndex({ auth, players }) {
  ...
  const filteredPlayers = useMemo(() => {
    return (players || []).filter((player) => {
      ...
      return player.name?.toLowerCase().includes(q) || player.position?.toLowerCase().includes(q) || player.position_number && String(player.position_number).includes(q);
    }).sort((a, b) => {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: "Analisis DPA", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "space-y-4 pb-6", children: [
      /* @__PURE__ */ jsx(
        ...
        {
          title: "Analisis DPA",
          description: "Evaluasi pola postur dinamis dan kompensasi otot.",
              ...
              isFilterOpen && /* @__PURE__ */ jsxs("div", { className: "absolute right-0 top-full mt-1.5 w-72 sm:w-80 bg-white rounded-lg shadow-xl border border-slate-200/80 p-4 z-30 animate-in fade-in zoom-in-95 duration-100 space-y-3.5", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between border-b border-slate-100 pb-2", children: [
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                    ...
                    /* @__PURE__ */ jsx("button", { type: "button", onClick: () => setIsFilterOpen(false), className: "text-slate-400 hover:text-slate-600 p-0.5 rounded transition-colors cursor-pointer", title: "Tutup", children: /* @__PURE__ */ jsx(X, { className: "w-3.5 h-3.5" }) })
                  ] })
                ] }),
      ...
      filteredPlayers.length === 0 ? /* @__PURE__ */ jsxs("div", { className: "col-span-full py-16 px-4 flex flex-col items-center justify-center bg-white border border-dashed border-slate-200 rounded-xl text-center space-y-3", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
          /* @__PURE__ */ jsx("h4", { className: "text-sm font-bold text-slate-800", children: "Klien Tidak Ditemukan" }),
          /* @__PURE__ */ jsxs("p", { className: "text-xs text-slate-400 font-medium max-w-sm", children: [
            'Pencarian untuk "',
            searchQuery,
            '" tidak menemukan hasil.'
          ] })
        ] }),
        activeFilterCount > 0 && /* @__PURE__ */ jsx("button", { type: "button", onClick: resetFilters, className: "px-3.5 py-1.5 text-xs font-bold text-orange-600 bg-white hover:bg-orange-50 border border-slate-200 hover:border-orange-300 rounded-md transition-all shadow-2xs cursor-pointer", children: "Reset Semua Filter" })
      ] }) : /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3.5", children: filteredPlayers.map((player) => {
        const photo = player.profile_photo ? `/storage/${player.profile_photo}` : player.photo_url;
        return /* @__PURE__ */ jsxs(
          Link,
          {
            ...
            children: [
              /* @__PURE__ */ jsxs("div", { className: "p-3.5 space-y-3 flex-1 flex flex-col justify-between", children: [
                /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-2.5", children: [
                  /* @__PURE__ */ jsx("div", { className: "w-10 h-10 sm:w-11 sm:h-11 rounded-md border-2 border-white shadow-2xs bg-gradient-to-br from-orange-50 to-orange-100/70 text-orange-600 font-black text-base flex items-center justify-center shrink-0 overflow-hidden", children: photo ? /* @__PURE__ */ jsx("img", { src: photo, alt: player.name, className: "w-full h-full object-cover" }) : /* @__PURE__ */ jsx("span", { className: "leading-none select-none", children: getInitials(player.name) }) }),
                  /* @__PURE__ */ jsxs("div", { className: "min-w-0 flex-1 space-y-0.5", children: [
                    /* @__PURE__ */ jsx("h3", { className: "font-bold text-slate-900 text-xs sm:text-[13px] truncate group-hover:text-orange-600 transition-colors leading-tight", children: player.name }),
                    /* @__PURE__ */ jsx("p", { className: "text-[11px] text-slate-500 font-medium truncate", children: player.position || "Klien" })
                  ] })
                ] }),
                /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-1.5 pt-0.5 border-t border-slate-100/90", children: [
                  /* @__PURE__ */ jsxs("div", { className: "p-1.5 bg-white/90 rounded-md border border-slate-200/70 shadow-2xs", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[8px] font-bold text-slate-400 uppercase tracking-wider block", children: "Riwayat" }),
                    /* @__PURE__ */ jsxs("div", { className: "flex items-baseline gap-0.5 mt-0.5", children: [
                      /* @__PURE__ */ jsx("span", { className: "text-[11.5px] font-black text-orange-600 leading-tight", children: player.total_records > 0 ? player.total_records : 0 }),
                      /* @__PURE__ */ jsx("span", { className: "text-[8px] font-normal text-slate-400", children: "tes" })
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxs("div", { className: "p-1.5 bg-white/90 rounded-md border border-slate-200/70 shadow-2xs", children: [
                    /* @__PURE__ */ jsx("span", { className: "text-[8px] font-bold text-slate-400 uppercase tracking-wider block", children: "Status" }),
                    /* @__PURE__ */ jsx("div", { className: "mt-0.5", children: /* @__PURE__ */ jsx("span", { className: `text-[9.5px] font-black leading-tight block truncate ${player.total_records > 0 ? "text-emerald-600" : "text-slate-400"}`, children: player.total_records > 0 ? "Terdata" : "Belum Ada" }) })
                  ] })
                ] })
              ] }),
