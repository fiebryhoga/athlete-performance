...
function Index({ athletes }) {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: "Wellness & Training Load", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "pb-12 space-y-6", children: [
      ...
      filteredAthletes.length > 0 ? /* @__PURE__ */ jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-5 animate-in fade-in duration-300", children: filteredAthletes.map((athlete) => /* @__PURE__ */ jsxs("div", { className: "group bg-white p-4 md:p-5 rounded-lg shadow-sm border border-slate-200 hover:border-orange-200 hover:shadow-lg transition-all hover:-translate-y-1 relative flex flex-col justify-between", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-start gap-3 md:gap-4 mb-4", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "min-w-0 pt-0.5 md:pt-1", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "mt-1 md:mt-1.5 flex items-center", children: /* @__PURE__ */ jsx("span", { className: "text-[10px] md:text-xs font-medium text-slate-500 bg-slate-50 px-2 py-0.5 rounded border border-slate-100 truncate max-w-[120px]", children: athlete.sport?.name || "Tanpa Cabor" }) })
          ] })
        ] }),
        /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between mt-auto pt-4 border-t border-slate-100", children: [
          /* @__PURE__ */ jsxs("div", { className: "text-[10px] md:text-xs font-bold text-slate-500 flex items-center gap-1.5", children: [
            /* @__PURE__ */ jsx(Activity, { className: "w-3.5 h-3.5 md:w-4 md:h-4 text-orange-500" }),
            /* @__PURE__ */ jsx("span", { className: "text-slate-800 text-sm md:text-base", children: athlete.total_records || 0 }),
            " Data Load"
          ] }),
          /* @__PURE__ */ jsxs(
            Link,
            {
              ...
              children: [
                "Detail ",
                /* @__PURE__ */ jsx(ChevronRight, { className: "w-3.5 h-3.5 md:w-4 md:h-4" })
              ]
            }
          )
        ] })
      ] }, athlete.id)) }) : /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center py-16 md:py-20 rounded-2xl border border-dashed border-slate-300 bg-slate-50/50 text-center shadow-sm mx-2 md:mx-0", children: [
        /* @__PURE__ */ jsx("div", { className: "p-4 bg-white border border-slate-200 rounded-full mb-3 shadow-sm", children: /* @__PURE__ */ jsx(Search, { className: "w-6 h-6 md:w-8 md:h-8 text-orange-500" }) }),
