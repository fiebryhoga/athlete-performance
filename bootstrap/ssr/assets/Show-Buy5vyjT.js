...
import ProfilingPdfDocument from "./ProfilingPdfDocument-BDlSEUsW.js";
import { pdf } from "@react-pdf/renderer";
import { ArrowLeft, Loader2, Download, Activity, ShieldCheck, Compass, User, TrendingUp, TrendingDown, Minus } from "lucide-react";
...
function Show({
  ...
  const coachNames = safeAthlete.coaches && safeAthlete.coaches.length > 0 ? safeAthlete.coaches.map((c) => c.name).join(", ") : safeAthlete.coach?.name || null;
  const hasGroups = safeAthlete.groups && safeAthlete.groups.length > 0;
  const membershipLabel = hasGroups ? safeAthlete.groups.length > 1 ? `${safeAthlete.groups.length} Grup` : safeAthlete.groups[0].name : safeAthlete.package?.name || "Privat";
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { title: `Profil - ${safeAthlete.name || "Athlete"}`, children: [
    /* @__PURE__ */ jsx(Head, { title: `Profil - ${safeAthlete.name || "Athlete Profile"}` }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-1", children: [
        ...
        /* @__PURE__ */ jsx(
          PageHeader,
          {
            ...
            actions: safeAthlete.id ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
              /* @__PURE__ */ jsx(
                "button",
                {
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-md border border-slate-200/80 shadow-2xs overflow-hidden hover:border-slate-300 transition-all", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "px-5 pb-4 pt-2.5 sm:pt-3", children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col lg:flex-row lg:items-center justify-between gap-4", children: [
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3.5 min-w-0", children: [
                /* @__PURE__ */ jsx("div", { className: "relative -mt-10 sm:-mt-12 w-[72px] h-[72px] sm:w-[80px] sm:h-[80px] rounded-md border-[3px] border-white shadow-md overflow-hidden bg-white text-orange-600 font-black text-xl sm:text-2xl flex items-center justify-center shrink-0 z-10", children: safeAthlete.profile_photo_url ? /* @__PURE__ */ jsx(
                  "img",
                  {
                ...
                /* @__PURE__ */ jsxs("div", { className: "space-y-1 min-w-0", children: [
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                    /* @__PURE__ */ jsx("h2", { className: "text-base sm:text-lg font-black text-slate-900 leading-tight", children: safeAthlete.name || "Unknown" }),
                    ...
                    /* @__PURE__ */ jsx(
                      "span",
                      {
                        className: `inline-flex items-center px-2 py-0.5 rounded text-[10px] font-semibold border ${hasGroups ? "bg-blue-50 text-blue-700 border-blue-200/70" : "bg-slate-100 text-slate-700 border-slate-200/70"}`,
                  ...
                  /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-xs text-slate-500 font-medium flex-wrap", children: [
                    ...
                    coachNames && /* @__PURE__ */ jsxs(Fragment, { children: [
                      /* @__PURE__ */ jsx("span", { className: "text-slate-300", children: "•" }),
                      /* @__PURE__ */ jsxs("span", { children: [
                        "Pelatih:",
                        " ",
                        /* @__PURE__ */ jsx("strong", { className: "text-slate-700 font-semibold", children: coachNames })
                      ] })
                    ] })
                  ] })
                ] })
          ...
          /* @__PURE__ */ jsxs("div", { className: "bg-gradient-to-br from-white via-white to-orange-50/40 border border-slate-200/80 rounded-md p-4 shadow-2xs hover:border-slate-300 transition-all", children: [
            ...
            /* @__PURE__ */ jsx("div", { className: "flex flex-col items-center justify-center pt-2 pb-1", children: /* @__PURE__ */ jsxs("div", { className: "relative w-48 h-26 flex items-end justify-center", children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: "absolute bottom-0 text-center pb-0.5", children: [
                /* @__PURE__ */ jsx("span", { className: "text-3xl font-black text-slate-900 leading-none", children: formatScore(stats?.average_score) }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-3 gap-1.5 text-center mt-3 pt-2.5 border-t border-slate-100", children: [
              /* @__PURE__ */ jsxs("div", { className: "p-2 bg-gradient-to-br from-white via-white to-orange-50/40 rounded-md border border-slate-200/80 shadow-2xs flex flex-col justify-between", children: [
                /* @__PURE__ */ jsx("span", { className: "text-[8.5px] font-bold text-slate-400 uppercase tracking-wider block", children: "Sesi Latihan" }),
              ...
              /* @__PURE__ */ jsxs("div", { className: "p-2 bg-gradient-to-br from-white via-white to-orange-50/40 rounded-md border border-slate-200/80 shadow-2xs flex flex-col justify-between", children: [
                /* @__PURE__ */ jsx("span", { className: "text-[8.5px] font-bold text-slate-400 uppercase tracking-wider block", children: "Tes Fisik" }),
                /* @__PURE__ */ jsxs("p", { className: "text-xs sm:text-sm font-black text-orange-600 leading-tight mt-0.5", children: [
                  stats?.total_tests ?? stats?.total_sessions ?? 0,
                  " ",
                  /* @__PURE__ */ jsx("span", { className: "text-[8.5px] font-normal text-slate-400", children: "tes" })
                ] })
              ] }),
              /* @__PURE__ */ jsxs("div", { className: "p-2 bg-gradient-to-br from-white via-white to-orange-50/40 rounded-md border border-slate-200/80 shadow-2xs flex flex-col justify-between", children: [
                /* @__PURE__ */ jsx("span", { className: "text-[8.5px] font-bold text-slate-400 uppercase tracking-wider block", children: "Skor Puncak" }),
                /* @__PURE__ */ jsx("p", { className: "text-xs sm:text-sm font-black text-emerald-600 leading-tight mt-0.5", children: formatScore(stats?.highest_score) })
              ] })
            ] })
          ] }),
          item_analysis && item_analysis.length > 0 && /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-md border border-slate-200/80 shadow-2xs overflow-hidden", children: [
            ...
            /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsxs("table", { className: "w-full text-xs text-left", children: [
              ...
              /* @__PURE__ */ jsx("tbody", { className: "divide-y divide-slate-100", children: [...item_analysis || []].sort(
