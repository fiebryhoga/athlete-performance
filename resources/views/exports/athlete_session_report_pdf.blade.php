...
<head>
    <meta charset="UTF-8">
    <title>Laporan Sesi - {{ $athlete->name }}</title>
    <style>
        @page {
            size: A4 landscape;
            margin: 12mm 15mm;
    ...
    <table class="header-table">
        <tr>
            <td width="75%" style="text-align: left;">
                ...
                <div class="subtitle">
                    Total Sesi: {{ $athlete->package->session_count ?? count($trainings) }}
                </div>
            </td>
    ...
    <table class="header-table">
        <tr>
            <td width="75%" style="text-align: left;">
                ...
                <div class="subtitle">
                    {{ \Carbon\Carbon::parse($training->date)->format('j F Y') }} | {{ $athlete->name }} | Sesi {{ $training->session_number }} / {{ $athlete->package->session_count ?? count($trainings) }} @if($training->location) | {{ $training->location }} @endif
                            ...
                            <tr class="page-break" style="page-break-inside: avoid;">
                                ...
                                <td style="width: 95%; vertical-align: top; padding: 6px; text-align: left;">
                                    ...
                                    @php
                                        ...
                                        if (isset($rpeRecords) && !empty($playerName)) {
                                            $actuals = [
                                                'load' => [],
                                                'reps' => [],
                                                'distance' => [],
