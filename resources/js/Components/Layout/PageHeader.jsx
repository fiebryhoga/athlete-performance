    ...
    return (
        <div className="bg-white p-5 md:p-8 rounded-lg border border-slate-200 shadow-sm mb-6 md:mb-8 relative flex flex-col lg:flex-row justify-between items-start lg:items-center gap-5 md:gap-6">
            ...
            <div className="relative z-10 w-full lg:w-auto">
                {badge && (
                    <span className="text-[10px] font-bold text-[#ff4d00] bg-orange-50 px-3 py-1 rounded-full uppercase tracking-widest mb-3 inline-block">
                        {badge}
                    </span>
                )}
                ...
                {subtitle && (
                    <p className="text-slate-500 font-medium mt-1 text-xs md:text-sm">{subtitle}</p>
                )}
            </div>
