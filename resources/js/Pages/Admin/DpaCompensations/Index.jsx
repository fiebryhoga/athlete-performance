                ...
                actions={
                    canCreate && (
                        <Link
                            ...
                            className="bg-[#ff4d00] text-white px-6 py-2.5 rounded-lg text-sm font-bold shadow-md hover:bg-[#e64500] active:scale-[0.98] transition-all flex items-center justify-center gap-2"
                        >
