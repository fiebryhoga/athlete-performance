            ...
            <div className="p-0">
                {currentCat.columns !=="note_only" ? (
                                                                    ...
                                                                    <div className="flex flex-wrap gap-4">
                                                                        {Array.from(
                                                                            ...
                                                                            (
                                                                                ...
                                                                                >
                                                                                    <span className="text-xs font-black text-zinc-800 border-b border-zinc-100 pb-2">
                                                                                        SET{""}
                                                                                        {setIdx +
                                                                                            1}
                                                                                    </span>
                    ...
                    <div className="p-6 bg-zinc-50/30">
                        <div className="flex items-center gap-2 mb-3 text-[10px] font-black text-zinc-400">
