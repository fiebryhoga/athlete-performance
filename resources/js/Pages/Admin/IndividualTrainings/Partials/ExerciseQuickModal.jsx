...
export default function ExerciseQuickModal({ isOpen, onClose }) {
 ...
 <div>
 <h3 className="text-lg font-bold italic tracking-tighter">Master Latihan</h3>
 ...
 className="inline-flex items-center gap-2 bg-zinc-900 text-white px-6 py-3 rounded-xl text-xs font-bold shadow-md hover:bg-zinc-800 transition-colors"
 >
