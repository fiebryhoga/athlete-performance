    ...
    return (
        <AppLayout title={`Tambah Sesi - ${athlete.name}`}>
            ...
            <form onSubmit={submitSession} className="space-y-6 md:space-y-8">
                {/* Basic Info */}
                <div className="bg-white p-6 md:p-8 border border-zinc-200 rounded-2xl shadow-sm">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="md:col-span-2 lg:col-span-3">
                            <div
                                ...
                                onClick={() =>
                                    setData("is_extra", !data.is_extra)
                                }
                            >
                                <input
                                    type="checkbox"
                                    ...
                                    onChange={(e) =>
                                        setData("is_extra", e.target.checked)
                                    }
                                    className="w-4 h-4 text-orange-500 rounded border-zinc-300 focus:ring-orange-500"
                                />
                                <label className="text-sm font-semibold text-zinc-800 cursor-pointer">
                                    Sesi Tambahan (Turnamen / PR / Latihan
                                    Mandiri)
                                    <span className="block text-xs text-zinc-500 mt-0.5">
                                        Sesi ini tidak akan memotong kuota paket
                                        latihan.
                                    </span>
                                </label>
                            </div>
                ...
                <div className="bg-zinc-50 border border-zinc-200 rounded-2xl overflow-hidden shadow-sm">
                    <div className="p-5 bg-white border-b border-zinc-200 flex justify-between items-center sticky top-0 z-40">
                    ...
                    <div className="p-6 md:p-8">
                        ...
                        {data.blocks.length === 0 && (
                            <div className="text-center py-16 bg-white border-2 border-zinc-200 border-dashed rounded-xl mt-4">
                                <div className="w-16 h-16 bg-zinc-50 rounded-full flex items-center justify-center mx-auto mb-4 border border-zinc-100 shadow-inner">
                                    <Dumbbell
                                        size={28}
