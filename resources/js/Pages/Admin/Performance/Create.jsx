...
export default function Create({ athletes = [] }) {
    ...
    return (
        <AppLayout title="Input Sesi Tes Fisik" noContainer>
            <Head title="Input Sesi Tes Fisik" />

            <div className="flex flex-col lg:flex-row min-h-[calc(100vh-64px)] bg-white">
                {/* Left Visual Hero */}
                <div className="lg:w-5/12 bg-gradient-to-br from-orange-600 to-[#cc3d00] relative overflow-hidden flex flex-col justify-between p-8 lg:p-12 text-white">
                    ...
                    <div className="relative z-10 space-y-4">
                        ...
                        <h1 className="text-2xl lg:text-3xl font-extrabold tracking-tight leading-snug">
                            Inisiasi Pengukuran Performa Fisik
                        </h1>
                        <p className="text-orange-100 text-xs sm:text-sm leading-relaxed max-w-sm">
                            Mulai sesi asesmen fisik baru untuk mengukur
                            kemajuan parameter performa atlet sesuai benchmark
                            cabang olahraga.
                        </p>
                    </div>

                    <div className="relative z-10 mt-10 lg:mt-0 hidden lg:block space-y-3">
                        <div className="flex items-center gap-3">
                            <div className="w-8 h-8 rounded-full bg-white text-orange-600 flex items-center justify-center font-bold text-xs shadow-md">
                                1
                            </div>
                        ...
                        <div className="h-6 border-l-2 border-white/30 ml-4 my-1"></div>
                ...
                <div className="lg:w-7/12 flex flex-col justify-center p-6 lg:p-14 bg-white relative">
                    <div className="max-w-md mx-auto w-full">
                        <div className="mb-6">
                            ...
                            <p className="text-slate-500 text-xs mt-1">
                                Lengkapi informasi atlet dan tanggal asesmen di
                                bawah ini.
                            </p>
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-5">
                            ...
                            <div className="space-y-1.5">
                                ...
                                {errors.date && (
                                    <p className="text-rose-600 text-xs font-bold mt-1 flex items-center gap-1">
                                        <X className="w-3 h-3" /> {errors.date}
                                    </p>
                                )}
                            </div>

                            {/* Athlete Select Field */}
                            <div
                            ...
                            >
                                ...
                                <div
                                    ...
                                    className={`w-full flex items-center justify-between px-3 py-2 border rounded-md cursor-pointer transition-all shadow-2xs ${
                                        isDropdownOpen
                                            ? "border-orange-500 ring-2 ring-orange-500/20 bg-white"
                                            : "border-slate-200 bg-white hover:border-slate-300"
                                    } ${errors.user_id ? "border-rose-300 bg-rose-50/40" : ""}`}
                                >
                                ...
                                {isDropdownOpen && (
                                    <div className="absolute z-50 mt-1.5 w-full bg-white rounded-lg shadow-xl border border-slate-200/80 overflow-hidden animate-in fade-in zoom-in-95 duration-100 origin-top">
                                                ...
                                                filteredAthletes.map(
                                                    (athlete) => (
                                                        <div
                                                            ...
                                                            className={`px-3 py-2 cursor-pointer rounded-md flex justify-between items-center text-xs transition-colors ${
                                                                data.user_id ===
                                                                athlete.id
                                ...
                                {errors.user_id && (
                                    <p className="text-rose-600 text-xs font-bold mt-1 flex items-center gap-1">
                                        <X className="w-3 h-3" /> Silakan pilih
                                        atlet terlebih dahulu
                                    </p>
                                )}
                            </div>
                            ...
                            <div className="space-y-1.5">
                                ...
                                <p className="text-[10.5px] text-slate-400">
                                    Jika dikosongkan, nama sesi otomatis
                                    menggunakan tanggal tes.
                                </p>
                            </div>
