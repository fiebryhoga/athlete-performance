        ...
        <AppLayout title="Input Test Scores" noContainer>
            ...
            <form onSubmit={submit} className="relative min-h-screen bg-slate-50/50 pb-28 md:pb-12">
                        ...
                        <div className="flex items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-3 md:gap-4 overflow-hidden">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <div className="flex items-center gap-2 text-[10px] md:text-xs text-slate-500 mt-1 truncate font-bold">
                            ...
                            <div className="hidden sm:flex items-center gap-4">
                                <div className={`text-[10px] font-bold transition-colors ${isDirty ? 'text-amber-500' : 'text-emerald-600 flex items-center gap-1'}`}>
                ...
                <div className="sm:hidden fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-slate-200 z-50 shadow-[0_-10px_30px_rgba(0,0,0,0.08)] flex gap-3 items-center">
                    <div className="flex-1 text-[10px] font-bold text-slate-500 pl-1">
