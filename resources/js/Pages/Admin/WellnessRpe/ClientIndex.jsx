                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                    {filteredAthletes.map(athlete => (
                        <Link key={athlete.id} href={route('admin.wellness-rpe.athlete.show', athlete.id)} className="block group">
                            <div className="bg-white border border-slate-200 hover:border-orange-500 hover:shadow-md hover:shadow-orange-500/10 rounded-xl p-5 transition-all flex flex-col h-full relative overflow-hidden group-hover:-translate-y-1">
