...
export default function AnalysisDetail({ weeklyData, athleteWeeklyInfo, onBack }) {
 ...
 <div className="w-10 h-10 rounded-full bg-slate-200  flex items-center justify-center font-black text-slate-500 text-sm  shrink-0 border border-slate-300 ">
 ...
 <span className="bg-slate-900 text-slate-100   px-4 py-1 rounded-md text-[10px] font-black shadow-sm">
 "Week" {week.week_number}
 </span>
 
 {idx === 0 && (
 <span className="bg-slate-100 text-slate-700 border border-slate-200    px-4 py-1 rounded-md text-[10px] font-bold">
 "Latest"
 </span>
 )}
 </div>
 ...
 <h4 className="text-xs font-black text-slate-400  text-center">"Load vs Wellness (Daily)"</h4>
 ...
 <div>
 <p className="text-[10px] font-black text-slate-400 ">"Peak Training Load"</p>
 <p className="font-bold text-slate-700  text-xs mt-0.5">"Day with Highest Load"</p>
 </div>
 <span className="font-black text-xl text-slate-900 ">{maxLoad} <span className="text-xs text-slate-400">"AU"</span></span>
 </div>
 <div className="bg-slate-50  p-4 rounded-xl border border-slate-200  flex items-center justify-between">
 <div>
 <p className="text-[10px] font-black text-slate-400 ">"Minimum Fitness"</p>
 ...
 <thead className="bg-slate-50/50  border-b border-slate-200  text-slate-500 text-[9px] font-black">
 <tr>
 ...
 className="inline-flex items-center gap-1 bg-slate-900  text-slate-50  text-[10px] font-black px-2.5 py-1 rounded hover:bg-slate-800  transition-colors"
 >
 <Eye size={10} /> "View"
 </button>
 ) : (
