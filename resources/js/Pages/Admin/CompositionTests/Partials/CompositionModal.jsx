...
export default function CompositionModal({
    ...
    const estimatedBMR = (() => {
        ...
        const w = parseFloat(data.weight),
            h = parseFloat(data.height) * 100,
            a = parseFloat(data.age);
        const bmr =
            athlete.gender === "L"
                ? 10 * w + 6.25 * h - 5 * a + 5
                : 10 * w + 6.25 * h - 5 * a - 161;
    ...
    const estimatedMetAge = (() => {
        ...
        const a = parseFloat(data.age),
            bf = parseFloat(data.body_fat_percentage);
                ...
                <div className="flex-1 xl:w-7/12 border-b xl:border-b-0 xl:border-r border-slate-200 flex flex-col overflow-y-auto custom-scrollbar">
                    <div className="sticky top-0 z-20 px-4 md:px-6 py-4 md:py-5 border-b border-slate-100 flex justify-between items-center bg-white shadow-sm">
                        <h3 className="font-bold text-base md:text-lg text-slate-800 flex items-center gap-2">
                            <Scale className="w-4 h-4 md:w-5 md:h-5 text-orange-500" />{" "}
                            Record Composition
                        </h3>
                        <button
                            onClick={onClose}
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6 mb-4 md:mb-6">
                            <div className="col-span-1 p-3 sm:p-4 bg-orange-50/50 rounded-lg border border-orange-100 shadow-sm">
                                <label className="text-[10px] font-bold text-orange-500 mb-1 block">
                                    Berat (KG)
                                </label>
                                <input
                                    type="number"
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 md:gap-4 border-t border-slate-100 pt-5">
                            <div>
                                <label className="text-[9px] md:text-[10px] font-bold text-slate-400 mb-1.5 block">
                                    Bodyfat %
                                </label>
                                <input
                                    type="number"
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setData("muscle_mass", e.target.value)
                                    }
                                    className="w-full rounded-lg border-slate-200 text-xs md:text-sm focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 bg-slate-50 focus:bg-white transition-all outline-none shadow-sm"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setData("bone_mass", e.target.value)
                                    }
                                    className="w-full rounded-lg border-slate-200 text-xs md:text-sm focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 bg-slate-50 focus:bg-white transition-all outline-none shadow-sm"
                                />
                            </div>
                            <div>
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setData("visceral_fat", e.target.value)
                                    }
                                    className="w-full rounded-lg border-slate-200 text-xs md:text-sm focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 bg-slate-50 focus:bg-white transition-all outline-none shadow-sm"
                                />
                            </div>
                            ...
                            <div className="col-span-2 sm:col-span-3 lg:col-span-1">
                                ...
                                <input
                                    ...
                                    onChange={(e) =>
                                        setData("metabolic_age", e.target.value)
                                    }
                                    className="w-full rounded-lg border-slate-200 text-xs md:text-sm focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 bg-slate-50 focus:bg-white transition-all outline-none shadow-sm"
                ...
                <div className="xl:w-5/12 bg-slate-50 flex flex-col relative border-t xl:border-t-0 border-slate-200 xl:border-none overflow-y-auto custom-scrollbar">
                    <div className="px-4 md:px-6 py-4 md:py-5 border-b border-slate-200 bg-slate-50 sticky top-0 z-10 flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-[10px] md:text-xs text-slate-500 mt-0.5">
                                Kalkulator jika Anda hanya membawa meteran pita.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="p-4 md:p-6 flex-1 flex flex-col pb-8">
                        {activeTool === "bodyfat" && (
                            <div className="space-y-4 animate-in fade-in duration-300">
                                <div className="bg-teal-50/50 p-3 md:p-4 rounded-lg border border-teal-100 text-[10px] md:text-xs text-teal-800 font-medium leading-relaxed">
                                    Menggunakan metode ukur US Navy. Pastikan
                                    input{" "}
                                    <strong className="font-bold text-teal-900">
                                        Tinggi Badan
                                    </strong>{" "}
                        ...
                        {activeTool === "bmr" && (
                            <div className="space-y-4 animate-in fade-in duration-300">
                                <div className="bg-teal-50/50 p-3 md:p-4 rounded-lg border border-teal-100 text-[10px] md:text-xs text-teal-800 font-medium leading-relaxed">
                                    Menggunakan rumus Mifflin-St Jeor (BMR) dan
                                    Watson (Air). Pastikan{" "}
                                    <strong className="font-bold text-teal-900">
                        ...
                        {activeTool === "mass" && (
                            <div className="space-y-4 animate-in fade-in duration-300">
                                <div className="bg-teal-50/50 p-3 md:p-4 rounded-lg border border-teal-100 text-[10px] md:text-xs text-teal-800 font-medium leading-relaxed">
                                    ...
                                    di form kiri sudah terisi agar sistem dapat
                                    memisahkan massa otot dan tulang secara
                                    akurat.
                                </div>
