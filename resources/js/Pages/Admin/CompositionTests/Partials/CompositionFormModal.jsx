...
export default function CompositionFormModal({
    isOpen,
    onClose,
    player,
    record = null,
                    ...
                    <div className="flex items-start gap-3 max-w-2xl relative z-10">
                        ...
                        <div className="space-y-0.5">
                            ...
                            <p className="text-xs font-medium text-orange-900/80 leading-relaxed">
                                ...
                                <strong>{"Lingkar Leher & Pinggang"}</strong>{" "}
                                lalu klik tombol untuk mengekstrak otomatis 10+
                                metrik anatomi.
                            </p>
                        </div>
                    </div>
