            ...
            <td className="sticky left-0 z-10 bg-white  group-hover:bg-zinc-50  border-r border-zinc-200  px-3 py-2 transition-colors">
                <div className="flex items-center gap-2">
                    <div
                        draggable
                        onDragStart={(e) =>
                            actions.handleDragStart(e, player.id)
                        }
                    ...
                    <div className="flex flex-col">
                        <span className="font-bold text-zinc-900  text-xs line-clamp-1">
                            {player.name}
                        </span>
                        <div className="flex items-center gap-1.5 mt-0.5">
                            <span className="text-[9px] font-bold text-zinc-500 bg-zinc-100  px-1 rounded">
                                {player.position}
                            </span>
            ...
            {COLUMNS.map((col) => (
                ...
                >
                    <input
                        ...
                        onPaste={(e) =>
                            actions.handleLocalPaste(e, visibleIdx, col.id)
                        }
