...
import { Scale, Activity, Flame, Zap } from "lucide-react";
...
const MetricGauge = ({
    ...
    return (
        <div className="bg-slate-50/50 hover:bg-slate-50/90 border border-slate-200/70 rounded-lg p-2.5 shadow-2xs space-y-1.5 transition-all">
            {/* Header: Label, Value & Evaluation Status */}
            <div className="flex items-center justify-between gap-2">
                <div className="flex items-center gap-1.5 min-w-0">
                    {Icon && (
                        <div className="w-5 h-5 rounded bg-white text-orange-500 flex items-center justify-center shrink-0 border border-slate-200/80 shadow-2xs">
                ...
                <div className="flex items-baseline gap-1.5 shrink-0">
                    <span className="text-xs font-black text-slate-900">
                        {val}
                        {unit && (
                            <span className="text-[9.5px] font-bold text-slate-400 ml-0.5">
                                {unit}
                            </span>
                        )}
                    </span>
            ...
            <div className="flex justify-between text-[8.5px] text-slate-400 font-medium -mt-1">
                <span>0</span>
                <span>
