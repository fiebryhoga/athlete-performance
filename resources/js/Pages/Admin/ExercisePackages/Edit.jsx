...
export default function Edit({ packageData, exercises = [] }) {
    const {
        data,
        setData,
        put,
    ...
    return (
        <AdminLayout title="Edit Paket Latihan">
            <Head title={`Edit Paket Latihan - ${packageData.name}`} />
            <div className="mb-8">
                ...
                <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-3">
                    ...
                    Edit Paket Latihan: {packageData.name}
                </h1>
                <p className="text-gray-600 mt-2">Ubah informasi dan daftar latihan dalam paket ini.</p>
            </div>
