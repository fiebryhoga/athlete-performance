        ...
        <AppLayout title="Bulk Create Latihan">
            ...
            <div className="mb-8">
                ...
                <h1 className="text-2xl font-bold text-gray-900 flex items-center gap-3">
                    <div className="p-2 bg-white border border-zinc-200 rounded-xl shadow-sm"><AlignLeft size={24} className="text-zinc-900"/></div>
                    Buat Latihan (Bulk)
                </h1>
                ...
                <form onSubmit={submit}>
                    <div className="p-8 space-y-8">
                        <div>
                            ...
                            <p className="text-xs text-zinc-500 mb-3">Semua latihan yang Anda ketik di bawah akan dimasukkan ke dalam kategori ini.</p>
                            <select
                                className="w-full md:w-1/2 py-3 px-4 bg-zinc-50 border border-zinc-200 rounded-xl text-sm font-semibold text-zinc-900 focus:ring-1 focus:ring-zinc-900 outline-none"
                        ...
                        <div className="pt-6 border-t border-zinc-100">
                            ...
                            <p className="text-xs text-zinc-500 mb-3">Pisahkan setiap nama latihan dengan baris baru (Enter). 1 baris = 1 latihan.</p>
                            <textarea
                                className={`w-full py-3 px-4 bg-zinc-50 border rounded-xl text-sm font-semibold text-zinc-900 outline-none resize-y min-h-[300px] leading-relaxed ${errors.names ? 'border-red-500 focus:ring-1 focus:ring-red-500' : 'border-zinc-200 focus:ring-1 focus:ring-zinc-900'}`}
                                value={data.names}
