                ...
                <div className="lg:w-full flex justify-center p-6 lg:p-12">
                    <div className="max-w-3xl w-full bg-white rounded-3xl shadow-sm border border-slate-100 p-8">
                        ...
                        <form onSubmit={submit} className="space-y-6">
                            ...
                            <div className="pt-6">
                                <button type="submit" disabled={processing} className="w-full bg-orange-500 text-white font-bold py-4 rounded-xl shadow-lg hover:bg-[#003666] transition-all flex justify-center items-center gap-2">
