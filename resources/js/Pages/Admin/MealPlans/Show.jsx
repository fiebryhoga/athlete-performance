                ...
                {planToDisplay && !isDraft ? (
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 items-start">
                        ...
                        <div className="lg:col-span-4 space-y-3.5">
                            {/* 1. Target Nutrisi & Makronutrisi (Sleek TdeeSummary Aesthetic) */}
                            <div className="bg-white border border-slate-200/80 rounded-md shadow-2xs overflow-hidden transition-colors">
                                {/* Header */}
                                <div className="px-4 py-3 border-b border-slate-100 bg-slate-50/50 flex items-center justify-between gap-2">
                                    ...
                                    <span className="text-[10px] font-bold text-orange-700 bg-orange-50 border border-orange-200/80 px-2 py-0.5 rounded-md capitalize">
                                ...
                                <div className="p-3.5 space-y-3.5">
                                    ...
                                    <div className="p-3 rounded-md bg-gradient-to-b from-white via-orange-50/20 to-orange-100/30 border border-slate-200/90 shadow-2xs hover:border-orange-200/90 transition-all">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="grid grid-cols-3 gap-2">
                                            ...
                                            {(() => {
                                                ...
                                                return (
                                                    <div className="bg-gradient-to-b from-white via-rose-50/15 to-rose-50/30 border border-slate-200/90 rounded-md p-2 text-center shadow-2xs hover:border-rose-200 transition-all">
                                            ...
                                            {(() => {
                                                ...
                                                return (
                                                    <div className="bg-gradient-to-b from-white via-amber-50/15 to-amber-50/30 border border-slate-200/90 rounded-md p-2 text-center shadow-2xs hover:border-amber-200 transition-all">
                                                        <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider block">
                                                            Lemak
                                                        </span>
                                                        <div className="flex items-baseline justify-center gap-0.5 mt-0.5">
                                            ...
                                            {(() => {
                                                ...
                                                return (
                                                    <div className="bg-gradient-to-b from-white via-emerald-50/15 to-emerald-50/30 border border-slate-200/90 rounded-md p-2 text-center shadow-2xs hover:border-emerald-200 transition-all">
                                                        <span className="text-[9px] font-bold text-slate-500 uppercase tracking-wider block">
                                                            Karbo
                                                        </span>
                                                        <div className="flex items-baseline justify-center gap-0.5 mt-0.5">
