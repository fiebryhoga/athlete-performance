                ...
                {filteredAthletes.length > 0 ? (
                        ...
                        {filteredAthletes.map((athlete) => (
                            <div key={athlete.id} className="group bg-white p-5 rounded-2xl shadow-sm border border-slate-200 hover:border-orange-200 hover:shadow-lg transition-all hover:-translate-y-1 relative flex flex-col justify-between overflow-hidden">
                                ...
                                <div className="relative flex items-start gap-4 mb-4">
                                    <div className="w-12 h-12 md:w-14 md:h-14 rounded-2xl overflow-hidden bg-gradient-to-br from-orange-50 to-orange-100 text-[#ff4d00] flex items-center justify-center font-bold text-lg md:text-xl shrink-0 border border-orange-100 shadow-inner group-hover:border-orange-200 transition-colors">
                                ...
                                <div className="flex items-center justify-between mt-auto pt-4 border-t border-slate-100">
                                    ...
                                    <Link 
                                        ...
                                        className="flex items-center gap-1 text-xs font-bold text-white bg-[#ff4d00] px-4 py-2 rounded-xl shadow-lg shadow-[#ff4d00]/20 hover:bg-[#e64500] hover:-translate-y-0.5 transition-all"
                                    >
                    ...
                    <div className="flex flex-col items-center justify-center py-20 rounded-2xl border border-dashed border-slate-300 bg-slate-50/50 text-center shadow-sm">
                        <div className="p-4 bg-white border border-slate-200 rounded-full mb-3 shadow-sm">
                            <Search className="w-8 h-8 text-[#ff4d00]" />
                        </div>
